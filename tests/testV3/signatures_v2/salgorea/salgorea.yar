rule salgorea
{
    ...
    strings:
        $s0 = { 55 8b ec 6a fe 68 a8 87 42 00 68 50 73 41 00 64 a1 00 00 00 00 50 83 ec 
        ...
        $s1 = { 00 00 a1 20 b5 42 00 33 c5 89 45 fc 53 56 33 c9 b0 01 57 8d 9b 00 00 00 
        ...
        $s2 = { 46 00 89 14 85 c0 17 47 00 42 81 fa 00 01 00 00 7c c0 33 c9 8a 91 80 e7 
        ...
        $s3 = { b6 bc 15 fc fd ff ff 99 f7 fe 0f b6 84 15 fc fd ff ff 8b 95 f8 fd ff ff 
        ...
        $s4 = { c1 e6 08 0b f7 89 34 90 42 83 c1 04 83 fa 08 7c d6 bb 80 f3 46 00 8b 70 
        ...
        $s5 = { f8 33 ca 33 f1 89 50 14 89 48 18 89 70 1c 81 fb 9c f3 46 00 0f 8c 35 ff 
        ...
        $s6 = { ef 46 00 8b 92 80 eb 46 00 89 91 c8 1b 47 00 8b 91 8c e7 46 00 03 d2 03 
        ...
        $s7 = { eb 08 0f b6 f3 33 14 b5 c0 f3 46 00 0f b6 70 e0 33 14 b5 c0 1b 47 00 47 
        ...
        $s8 = { 33 14 b5 c0 1b 47 00 89 51 fc 8b 55 08 3b ba 00 02 00 00 0f 8c ff fe ff 
        ...
        $s9 = { 8b 5d ec c1 e6 08 0b f0 8b 45 08 33 70 0c c1 eb 08 89 75 e8 0f b6 f3 8b 
        ...
        $s10 = { f4 8b 75 e8 c1 ee 18 0f b6 da 8b 14 b5 c0 13 47 00 33 14 9d c0 0b 47 00 
        ...
        $s11 = { 9d c0 13 47 00 8b 5d fc 89 75 e8 c1 eb 08 0f b6 f3 8b 34 b5 c0 0b 47 00 
        ...
        $s12 = { 18 33 34 9d c0 13 47 00 0f b6 d9 33 34 9d c0 07 47 00 8b da 33 70 34 c1 
        ...
        $s13 = { 47 00 8b da c1 eb 08 0f b6 f3 8b 34 b5 c0 0b 47 00 8b 5d f4 c1 eb 10 0f 
        ...
        $s14 = { 5d ec 33 50 4c c1 eb 08 0f b6 f3 8b 34 b5 c0 0b 47 00 8b 5d f0 c1 eb 10 
        ...
        $s15 = { f3 8b 5d f8 c1 e9 10 0f b6 c9 c1 ea 18 8b 14 95 c0 13 47 00 33 14 b5 c0 
        ...
        $s16 = { 47 00 8b 5d fc 89 75 e8 c1 eb 08 0f b6 f3 8b 34 b5 c0 0b 47 00 31 75 e8 
        ...
        $s17 = { 9d c0 13 47 00 0f b6 d9 33 34 9d c0 07 47 00 8b da 33 70 74 c1 eb 10 89 
        ...
        $s18 = { da c1 eb 08 0f b6 f3 8b 34 b5 c0 0b 47 00 8b 5d f4 c1 eb 10 0f b6 db 33 
        ...
        $s19 = { b5 c0 07 47 00 8b 5d ec 33 90 8c 00 00 00 c1 eb 08 0f b6 f3 8b 34 b5 c0 
        0b 47 00 8b 5d f0 c1 eb 10 0f b6 db 33 34 9d c0 0f 47 00 8b d9 c1 eb 18 
        33 34 9d c0 13 47 00 0f b6 da 33 34 9d c0 07 47 00 05 90 00 00 00 33 30 
        8b da c1 eb 08 89 75 fc 0f b6 f3 8b 5d ec 8b 34 b5 c0 0b 47 00 c1 eb 10 
        0f b6 db 33 34 9d c0 0f 47 00 8b 5d f0 c1 eb 18 33 34 9d c0 13 47 00 0f 
        b6 d9 33 34 9d c0 07 47 00 8b da 33 70 04 c1 eb 10 89 75 f8 0f b6 f3 8b 
        34 b5 c0 0f 47 00 8b 5d ec c1 eb 18 33 34 9d c0 13 47 00 8b d9 89 75 e8 
        c1 eb 08 0f b6 f3 8b 34 b5 c0 0b 47 00 31 75 e8 0f b6 5d f0 8b 75 e8 33 
        34 9d c0 07 47 00 8b 5d }
    condition:
        any of them
}