rule doina
{
    ...
    strings:
        ...
        $s4 = { ff ff 00 00 00 00 c7 85 38 ff ff ff 00 00 00 00 c7 85 34 ff ff ff 00 00 
        ...
        $s5 = { c3 08 53 68 08 00 00 00 e8 af 4e 04 00 83 c4 04 5b 89 03 8b f8 be 41 d2 
        ...
        $s6 = { ff ff 00 00 00 00 c7 85 04 ff ff ff 00 00 00 00 c7 85 00 ff ff ff 00 00 
        ...
        $s7 = { 68 01 01 00 80 6a 00 68 2f 00 00 00 68 01 00 00 00 bb 40 01 00 00 e8 ea 
        ...
        $s8 = { 01 00 00 e8 36 54 04 00 83 c4 10 89 85 c8 fe ff ff 68 01 01 00 80 6a 00 
        ...
        $s9 = { 01 00 80 6a 00 68 64 00 00 00 68 01 00 00 00 bb 40 01 00 00 e8 5e 53 04 
        ...
        $s10 = { 00 e8 aa 52 04 00 83 c4 10 89 85 9c fe ff ff 68 01 01 00 80 6a 00 68 72 
        ...
        $s11 = { ff ff b9 13 00 00 00 e8 2f f7 ff ff 83 c4 4c 89 85 90 fe ff ff 8b 9d dc 
        ...
        $s12 = { db 74 09 53 e8 48 49 04 00 83 c4 04 8b 9d b4 fe ff ff 85 db 74 09 53 e8 
        ...
        $s13 = { 05 f6 ff ff 83 c4 08 83 f8 00 b8 00 00 00 00 0f 94 c0 89 85 8c fe ff ff 
        ...
        $s14 = { fe ff ff 85 db 74 09 53 e8 b6 47 04 00 83 c4 04 8b 9d d8 fe ff ff 85 db 
        ...
        $s15 = { 01 00 00 00 bb 40 01 00 00 e8 bf 4e 04 00 83 c4 10 89 85 dc fe ff ff 68 
        ...
        $s16 = { c8 fe ff ff 68 01 01 00 80 6a 00 68 78 00 00 00 68 01 00 00 00 bb 40 01 
        ...
        $s17 = { 00 00 bb 40 01 00 00 e8 33 4d 04 00 83 c4 10 89 85 b0 fe ff ff ff b5 b0 
        ...
        $s18 = { e8 a2 44 04 00 83 c4 04 8b 9d c8 fe ff ff 85 db 74 09 53 e8 8f 44 04 00 
        83 c4 04 8b 9d c4 fe ff ff 85 db 74 09 53 e8 7c 44 04 00 83 c4 04 8b 9d 
        c0 fe ff ff 85 db 74 09 53 e8 69 44 04 00 83 c4 04 8b 9d bc fe ff ff 85 
        db 74 09 53 e8 56 44 04 00 83 c4 04 8b 9d b8 fe ff ff 85 db 74 09 53 e8 
        43 44 04 00 83 c4 04 8b 9d b4 fe ff ff 85 db 74 09 53 e8 30 44 04 00 83 
        c4 04 8b 9d b0 fe ff ff 85 db 74 09 53 e8 1d 44 04 00 83 c4 04 8b 85 ac 
        fe ff ff 50 8b 9d e0 fe ff ff ff 33 e8 85 f1 ff ff 83 c4 08 83 f8 00 b8 
        00 00 00 00 0f 94 c0 89 85 a8 fe ff ff 8b 9d ac fe ff ff 85 db 74 09 53 
        e8 e2 43 04 00 83 c4 04 }
        $s19 = { 04 83 bd a8 fe ff ff 00 0f 84 d6 03 00 00 68 00 00 00 00 bb 04 01 00 00 
        e8 b4 4b 04 00 83 c4 04 89 85 e0 fe ff ff 68 01 01 00 80 6a 00 68 5c 00 
        00 00 68 01 00 00 00 bb 40 01 00 00 e8 70 4b 04 00 83 c4 10 89 85 dc fe 
        ff ff 68 00 00 00 00 bb 08 01 00 00 e8 18 4c 04 00 83 c4 04 89 85 d8 fe 
        ff ff ff b5 d8 fe ff ff ff b5 dc fe ff ff ff b5 e0 fe ff ff b9 03 00 00 
        00 e8 85 f0 ff ff 83 c4 0c 89 85 d4 fe ff ff 8b 9d e0 fe ff ff 85 db 74 
        09 53 e8 49 43 04 00 83 c4 04 8b 9d dc fe ff ff 85 db 74 09 53 e8 36 43 
        04 00 83 c4 04 8b 9d d8 fe ff ff 85 db 74 09 53 e8 23 43 04 00 83 c4 04 
        68 01 01 00 80 6a 00 68 }
    condition:
        any of them
}