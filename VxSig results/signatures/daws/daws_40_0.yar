rule daws_40_0 {
  ...
  strings:
    $ = {
         400033c4898424
         // 0040106b: xor eax, esp
         // 0040106d: mov ss:[esp+0x59c], eax
      [-]400033c4894424
         // 00401358: xor eax, esp
         // 0040135a: mov ss:[esp+0x50], eax
      [-]400033c489
         // 0040212b: xor eax, esp
         // 0040212d: mov ss:[esp+0xd8], eax
      [-]400033c489
      ...
      [-]33ccb8????????e8
         // 00402409: xor ecx, esp
         // 0040240b: mov eax, 0x1
         // 00402410: call @__security_check_cookie@4
      [-]68????????
         // 00402d85: push 0xf003f
      [-]400033c4898424
         // 00401c41: xor eax, esp
         // 00401c43: mov ss:[esp+0x928], eax
      [-]ffff85c0
