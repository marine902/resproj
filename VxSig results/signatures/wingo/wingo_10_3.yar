rule wingo_10_3 {
  ...
  strings:
    $ = {
         8904248966
         // 004647fd: mov ss:[rsp], rax
         // 00464801: mov ds:[rsi+0x38], rsp
      [-]8b04248946
         // 00464888: mov rax, ss:[rsp]
         // 0046488c: mov ds:[rsi+0x38], rax
      [-]85db0f84
         // 0046e20a: test ebx, ebx
         // 0046e20c: jz 0x46e2f1
      [-]83fb400f86
         // 0046e249: cmp ebx, 0x40
         // 0046e24c: jbe 0x46e31c
      [-]10f30f7f
