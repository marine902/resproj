  ...
  strings:
    $ = {
      ...
      [-]660f38dcc083
         ...
         // 00478501: cmp ebx, 0x10
      [-]660f6fd1660f6fd9660fef
         // 1400744ec: movdqa b16 xmm2, b16 xmm1
         // 1400744f0: movdqa b16 xmm3, b16 xmm1
         // 140074524: pxor b16 xmm5, b16 cs:[0x14062ab70]
      [-]00660fef
         // 140074534: pxor b16 xmm7, b16 cs:[0x14062ab90]
      [-]660f38dc
         // 14007453c: aesenc b16 xmm1, b16 xmm1
      [-]660f38dc
         // 140074541: aesenc b16 xmm2, b16 xmm2
      [-]660f38dc
         // 140074546: aesenc b16 xmm3, b16 xmm3
      ...
      [-]008d4424
         // 0046e796: lea eax, ss:[esp+0xc]
      [-]00894424
         // 0046e7a2: mov ss:[esp+0x4], eax
