rule xmrminer_10_1 {
  ...
  strings:
    $ = {
      ...
      [-]40534883ec20b9????????e864b1080033d2488944243041b8????????488bc8488bd8e8089f0a00488d8b00100000ba????????e89394080033c048891d66
         // 140001020: push rbx
         ...
         // 14000105b: mov cs:[0x1401503c8], rbx
      [-]14004889835010000048898358100000488983601000004883c4205bc3
      ...
      [-]4883ec28b9????????e8f6b00800488d0d
         // 140001090: sub rsp, 0x28
         // 140001094: mov b4 ecx, b4 0x30
         // 140001099: call ??2@YAPEAX_K@Z
         // 14000109e: lea rcx, cs:[0x140112e00]
      [-]1100488900488940084889401066c74018010148890543
         // 1400010a5: mov ds:[rax], rax
         // 1400010a8: mov ds:[rax+0x8], rax
         // 1400010ac: mov ds:[rax+0x10], rax
         // 1400010b0: mov b2 ds:[rax+0x18], b2 0x101
         // 1400010b6: mov cs:[0x140150400], rax
      [-]140048c70548
         // 1400010bd: mov cs:[0x140150410], 0x0
      [-]1400000000004883c428e93fb30800
         // 1400010c8: add rsp, 0x28
         // 1400010cc: jmp atexit
      [-]1100e924b30800
         // 1400010e7: jmp atexit
      [-]4883ec28b9????????e896b00800488d0d
         // 1400010f0: sub rsp, 0x28
         // 1400010f4: mov b4 ecx, b4 0x30
         // 1400010f9: call ??2@YAPEAX_K@Z
         // 1400010fe: lea rcx, cs:[0x140112e20]
      [-]1100488900488940084889401066c74018010148890513
         // 140001105: mov ds:[rax], rax
         // 140001108: mov ds:[rax+0x8], rax
         // 14000110c: mov ds:[rax+0x10], rax
         // 140001110: mov b2 ds:[rax+0x18], b2 0x101
         // 140001116: mov cs:[0x140150430], rax
      [-]140048c70518
         // 14000111d: mov cs:[0x140150440], 0x0
      [-]1400000000004883c428e9dfb20800
         // 140001128: add rsp, 0x28
         // 14000112c: jmp atexit
      [-]4883ec28b9????????e86eb508004c8b0513
         // 140001140: sub rsp, 0x28
         // 140001144: mov b4 ecx, b4 0x2
         // 140001149: call j_??2@YAPEAX_K@Z
         // 14000114e: mov r8, cs:[0x14014be68]
      [-]1400488d15
         // 140001155: lea rdx, cs:[0x14012c7c4]
      [-]120049ffc0488905fa
         // 14000115c: inc r8
         // 14000115f: mov cs:[0x14014be60], rax
      [-]1400488bc8e8d2990a00488d0d
         // 140001166: mov rcx, rax
         // 140001169: call memmove
         // 14000116e: lea rcx, cs:[0x140112e30]
      [-]1c11004883c428e992b20800
         // 140001175: add rsp, 0x28
         // 140001179: jmp atexit
      [-]4883ec28b9????????e82eb508004c8b05e3
         // 140001180: sub rsp, 0x28
         // 140001184: mov b4 ecx, b4 0x2
         // 140001189: call j_??2@YAPEAX_K@Z
         // 14000118e: mov r8, cs:[0x14014be78]
      [-]1400488d15
         // 140001195: lea rdx, cs:[0x14012c7dc]
      [-]120049ffc0488905ca
         // 14000119c: inc r8
         // 14000119f: mov cs:[0x14014be70], rax
      [-]1400488bc8e892990a00488d0d
         // 1400011a6: mov rcx, rax
         // 1400011a9: call memmove
         // 1400011ae: lea rcx, cs:[0x140112e40]
      [-]1c11004883c428e952b20800
         // 1400011b5: add rsp, 0x28
         // 1400011b9: jmp atexit
      [-]4883ec28b9????????e8eeb408004c8b05b3
         // 1400011c0: sub rsp, 0x28
         // 1400011c4: mov b4 ecx, b4 0x4
         // 1400011c9: call j_??2@YAPEAX_K@Z
         // 1400011ce: mov r8, cs:[0x14014be88]
      [-]1400488d15
         // 1400011d5: lea rdx, cs:[0x14012ceec]
      [-]120049ffc04889059a
         // 1400011dc: inc r8
         // 1400011df: mov cs:[0x14014be80], rax
      [-]1400488bc8e852990a00488d0d
         // 1400011e6: mov rcx, rax
         // 1400011e9: call memmove
         // 1400011ee: lea rcx, cs:[0x140112ec0]
      [-]1c11004883c428e912b20800
      ...
      [-]b8????????ba????????8605e4
         ...
         // 14000125a: xchg b1 al, b1 cs:[0x140150344]
      [-]1400488d0541
         // 140001260: lea rax, cs:[0x1401503a8]
      [-]1400660f1f840000000000
      ...
      [-]4883ec28488d0de1
         ...
         // 140001288: lea rcx, cs:[0x14014e770]
      [-]1400e820960800488d0d
         // 14000128f: call ??0_Init_locks@std@@QEAA@XZ
         // 140001294: lea rcx, cs:[0x140112f4c]
      [-]1c11004883c428e96cb10800
      ...
      [-]f20f5e05
         // 1400014f8: divsd b16 xmm0, cs:[0x1401344b0]
      [-]13008d82????????3d????????7d04
      ...
      [-]488d0dad
         // 14000151c: lea rcx, cs:[0x14012b4d0]
      [-]1200482bc8f20f5e01c3
      ...
      [-]488d0d8f
         // 14000153a: lea rcx, cs:[0x14012b4d0]
      [-]1200f20f590408c3
      ...
      [-]f30f6f11f30f6f25b6
         ...
         // 1400015b2: movdqu b16 xmm4, b16 cs:[0x14012af70]
      [-]1200660f6fdaf30f6f2dba
         // 1400015ba: movdqa b16 xmm3, b16 xmm2
         // 1400015be: movdqu b16 xmm5, b16 cs:[0x14012af80]
      [-]1200660f6fc2660f74dd0f29742410f30f6f35b5
         // 1400015c6: movdqa b16 xmm0, b16 xmm2
         // 1400015ca: pcmpeqb b16 xmm3, b16 xmm5
         // 1400015ce: movaps b16 ss:[rsp+0x10], b16 xmm6
         // 1400015d3: movdqu b16 xmm6, b16 cs:[0x14012af90]
      [-]1200660f6fca660f74c40f293c24f30f6f3db1
         // 1400015db: movdqa b16 xmm1, b16 xmm2
         // 1400015df: pcmpeqb b16 xmm0, b16 xmm4
         // 1400015e3: movaps b16 ss:[rsp], b16 xmm7
         // 1400015e7: movdqu b16 xmm7, b16 cs:[0x14012afa0]
      [-]1200660febd8660f74ce660f74d7660febd9660febda660fd7c366f7d06685c0753e
      ...
      [-]498bc24883c418c3
         ...
         // 140001ff2: retn 
      [-]40555657488bec4881ec8000000048c745a0feffffff48899c24b0000000488bda488bf9488b4120488945b033f6488975b80f57c0660f7f45c0660f6f0d
         // 140002000: push rbp
         // 140002002: push rsi
         // 140002003: push rdi
         ...
         // 14000203a: movdqa b16 xmm1, b16 cs:[0x140134500]
      [-]1300660f7f4dd0c745f0????????48894d208975e0488975e8488d45b048894528488b0a
      ...
      [-]488b5c24304883c4205fc3
         ...
         // 1400023fc: pop rdi
         // 1400023fd: retn 
      [-]488bc4448848204c894018488950105556574154415541564157488d68a14881ec9000000048c745b7feffffff488958080f2970b80f2978a8440f294098440f2948884c8be90f10020f1145cf488955df66480f7ec348ffc348895dcf488bf948894dbf4533f64c8b65d7
      ...
      [-]448975c790
         // 1400024eb: mov b4 ss:[rbp+0xffffffffffffffc7], b4 r14d
         // 1400024ef: nop 
      [-]4c8d
         // 1400024f0: lea r15, ds:[rbx+0xf]
         // 1400024f4: and r15, 0xfffffffffffffff0
         // 1400024f8: cmp rbx, r15
         // 1400024fb: jz 0x14000255d
