rule salgorea_40_0 {
  ...
  strings:
    $ = {
      ...
      [-]8bff558bec56ff75088bf1e8
         // 00457b88: mov edi, edi
         // 00457b8a: push ebp
         // 00457b8b: mov ebp, esp
         // 00457b8d: push esi
         // 00457b8e: push ss:[ebp+0x8]
         // 00457b91: mov esi, ecx
         // 00457b93: call 0x44ca17
      [-]008bc65e5dc20400
         // 00457b9e: mov eax, esi
         // 00457ba0: pop esi
         // 00457ba1: pop ebp
         // 00457ba2: retn b2 0x4
      [-]8bff558bec56ff75088bf1e8
      ...
      [-]ffffc706
         // 0042042e: mov ds:[esi], ??_7bad_cast@std@@6B@
      [-]008bc65e5dc20400
