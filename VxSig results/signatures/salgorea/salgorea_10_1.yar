  ...
  strings:
    $ = {
      ...
      [-]8bff558bec56ff75088bf1e8
         // 00410649: mov edi, edi
         // 0041064b: push ebp
         // 0041064c: mov ebp, esp
         // 0041064e: push esi
         // 0041064f: push ss:[ebp+0x8]
         // 00410652: mov esi, ecx
         // 00410654: call ??0exception@std@@QAE@ABV01@@Z
      [-]8bc65e5dc20400
         // 0041065f: mov eax, esi
         // 00410661: pop esi
         // 00410662: pop ebp
         // 00410663: retn b2 0x4
      [-]8bff558bec56ff75088bf1e8
         // 00410696: mov edi, edi
         // 00410698: push ebp
         // 00410699: mov ebp, esp
         // 0041069b: push esi
         // 0041069c: push ss:[ebp+0x8]
         // 0041069f: mov esi, ecx
         // 004106a1: call ??0exception@std@@QAE@ABV01@@Z
      [-]008bc65e5dc20400
         // 004106ac: mov eax, esi
         // 004106ae: pop esi
         // 004106af: pop ebp
         // 004106b0: retn b2 0x4
      [-]8bff558bec56ff75088bf1e8
