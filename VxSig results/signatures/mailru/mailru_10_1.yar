rule mailru_10_1 {
  ...
  strings:
    $ = {
         ...
         // 00401723: push esi
      [-]807d0c0074
         // 00401751: cmp b1 ss:[ebp+0xc], b1 0x0
         // 00401755: jz 0x4017a7
      ...
      [-]ff750c6a0056e8
         // 0040450d: push ss:[ebp+0xc]
         // 00404510: push 0x0
         // 00404512: push esi
         // 00404513: call _memset
      [-]8be55dc3
         // 0040452f: mov esp, ebp
         // 00404531: pop ebp
         // 00404532: retn 
      [-]8b461040508d45
         // 004045e4: mov eax, ds:[esi+0x10]
         // 004045e7: inc eax
         // 004045e8: push eax
         // 004045e9: lea eax, ss:[ebp+0xffffffffffffff9c]
      [-]40505657e8
         // 0040455a: inc eax
         // 0040455b: push eax
         // 0040455c: push esi
      ...
      [-]14????????
         // 00404978: mov ds:[esi+0x10], 0x0
      [-]c745f0????????e8
         // 0040498e: mov ss:[ebp+0xfffffffffffffff0], 0x1
         // 00404995: call 0x402ea0
      [-]ffff6aff6a00
         // 00404a7d: push 0xffffffffffffffff
         // 00404a7f: push 0x0
      ...
      [-]558bec8b
         // 00406350: push ebp
         // 00406351: mov ebp, esp
         // 00406355: mov edi, ss:[ebp+0x8]
      ...
      [-]8b4424048b5424088910894804c20800
         // 00417970: mov eax, ss:[esp+0x4]
         // 00417974: mov edx, ss:[esp+0x8]
         // 00417978: mov ds:[eax], edx
         // 0041797a: mov ds:[eax+0x4], ecx
         // 0041797d: retn b2 0x8
      [-]64a1????????50a1
      ...
      [-]feffc74424
         // 00419c03: mov ss:[esp+0x50], 0xffffffffffffffff
      [-]00c64424
         // 004184a5: mov b1 ss:[esp+0x24], b1 0x0
      [-]8a014184c075f9
         // 00418580: mov b1 al, b1 ds:[ecx]
         // 00418582: inc ecx
         // 00418583: test b1 al, b1 al
         // 00418585: jnz 0x418580
      [-]feff83c404
         // 00418397: add esp, 0x4
      [-]00c64424
         // 0041865a: mov b1 ss:[esp+0x14], b1 0x0
