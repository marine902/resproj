  ...
  strings:
    $ = {
      ...
      [-]8b0089018b068908
         ...
         // 00404f9c: mov ds:[eax], ecx
      [-]8b068901890e
         // 00404fa5: mov eax, ds:[esi]
         // 00404fa7: mov ds:[ecx], eax
         // 00404fad: mov ds:[esi], ecx
      [-]8b0985c97411
      ...
      [-]c7442414????????c705
         ...
         // 0041818c: mov ds:[0x425b60], ??_7system_error_category@?A0x846d1564@system@boost@@6B@
      [-]8b4424188930c74004
      ...
      [-]8b471083cb048946108b4714894614
