rule shyape_10_1 {
  ...
  strings:
    $ = {
      ...
      [-]5784c074
         // 00401236: push edi
         // 00401237: test b1 al, b1 al
         // 00401239: jz 0x40125f
      [-]0fbec099
      ...
      [-]8bc8c1e902f3a58bc883e103f3a48b
         // 004012d1: mov ecx, eax
         // 004012d3: shr ecx, b1 0x2
         // 004012d6: rep movsdd 
         // 004012d8: mov ecx, eax
         // 004012da: and ecx, 0x3
         // 004012dd: rep movsbb 
         // 004012df: mov ecx, ss:[esp+0x20]
      [-]68????????8d
         // 00401314: push 0x103
      ...
      [-]516a00ff15
         // 00401336: push ecx
         // 00401337: push 0x0
         // 00401339: call ds:[GetModuleFileNameA]
      [-]400085c075
         // 0040133f: test eax, eax
         // 00401341: jnz 0x40135a
      [-]52894804e8
         // 00401395: push edx
      ...
      [-]89088b0d
         // 00401624: mov ds:[eax], ecx
         // 00401626: mov ecx, ds:[0x4104a8]
      [-]8950048b15
         // 0040162c: mov ds:[eax+0x4], edx
         // 0040162f: mov edx, ds:[0x4104ac]
      [-]8948088b0d
         // 00401635: mov ds:[eax+0x8], ecx
         // 00401638: mov ecx, ds:[0x4104b0]
      [-]89500c8a15
         // 0040163e: mov ds:[eax+0xc], edx
         // 00401641: mov b1 dl, b1 ds:[0x4104b4]
      [-]00894810885014a1
         // 00401647: mov ds:[eax+0x10], ecx
         // 0040164a: mov b1 ds:[eax+0x14], b1 dl
         // 0040164d: mov eax, ds:[0x410488]
      [-]2bc18bf1
      ...
      [-]6a006a01ffd78b
         ...
         // 004017ca: push 0x1
         // 004017cc: call edi
         // 004017ce: mov ebp, ds:[WideCharToMultiByte]
      [-]000083c4
      ...
      [-]85f67409
         // 00401a5c: test esi, esi
         // 00401a5e: jz 0x401a69
      [-]000083c404
      ...
      [-]535756e8
         ...
         // 00401eb6: push edi
         // 00401eb7: push esi
         // 00401eb8: call 0x401da0
      [-]feffff8d7e10
         // 00401ebd: lea edi, ds:[esi+0x10]
      [-]faffff83c4
         // 00401ec9: add esp, 0xc
      [-]833e01740a
         // 00401ecc: cmp ds:[esi], 0x1
         // 00401ecf: jz 0x401edb
      [-]83f8ff7523
      ...
      [-]400085c075
         // 00402b5e: test eax, eax
         // 00402b60: jnz 0x402b68
      [-]68????????e8
         // 00402b68: push 0x400
      ...
      [-]400050ff15
         // 00402c5f: push eax
         // 00402c60: call ds:[SetPriorityClass]
      [-]40006a0fff15
         // 00402c66: push 0xf
         // 00402c68: call ds:[GetCurrentThread]
      [-]400050ff15
         // 00402c6e: push eax
         // 00402c6f: call ds:[SetThreadPriority]
      [-]6a00506a
         // 00402c7a: push 0x0
         // 00402c7c: push eax
         // 00402c7d: push 0x1
      ...
      [-]558bec83ec
         // 00409e06: push ebp
         // 00409e07: mov ebp, esp
         // 00409e09: sub esp, 0x24
      [-]535657e8
         // 00409e19: push ebx
         // 00409e20: push esi
         // 00409e21: push edi
         // 00409e25: call __encoded_null
      [-]5f5e5bc9c3
         // 0040b159: pop edi
         // 0040b15a: pop esi
         // 0040b15b: pop ebx
