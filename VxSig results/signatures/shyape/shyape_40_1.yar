rule shyape_40_1 {
  ...
  strings:
    $ = {
      ...
      [-]8a08880c02
         // 00401620: mov b1 cl, b1 ds:[eax]
         // 00401622: mov b1 ds:[edx+eax], b1 cl
      [-]2bc18bf1
      ...
      [-]8a08880c02
         // 00401e85: mov b1 cl, b1 ds:[eax]
         // 00401e87: mov b1 ds:[edx+eax], b1 cl
      [-]535756e8
         // 00401db4: push ebx
         // 00401db5: push edi
         // 00401db6: push esi
      ...
      [-]8a540701881406
         // 00401fd0: mov b1 dl, b1 ds:[edi+eax+0x1]
         // 00401fd4: mov b1 ds:[esi+eax], b1 dl
