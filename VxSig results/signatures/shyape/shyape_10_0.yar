  ...
  strings:
    $ = {
      ...
      [-]000083c40485c0a3
         ...
         // 00401767: test eax, eax
         // 0040176a: mov ds:[0x41479c], eax
      [-]8d7c000257e8
