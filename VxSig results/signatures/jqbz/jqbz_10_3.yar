rule jqbz_10_3 {
  ...
  strings:
    $ = {
      ...
      [-]400008eb05
         // 08003466: jmp 0x800346d
      [-]85c0750b
         // 0800346d: test eax, eax
         // 0800346f: jnz 0x800347c
      [-]ff1508400008a3
         // 08003471: call ds:[GetLastError]
         // 08003477: mov ds:[0x800446c], eax
      ...
      [-]400008a3??
         // 080034c0: mov ds:[0x80043ec], eax
      [-]85c0750b
         // 080034c5: test eax, eax
         // 080034c7: jnz 0x80034d4
      [-]ff1508400008a3
         // 080034c9: call ds:[GetLastError]
         // 080034cf: mov ds:[0x800410a], eax
      [-]6a00ff35
         // 080034d9: push 0x0
      ...
      [-]ff1508400008a3
         // 0800350f: call ds:[GetLastError]
         // 08003515: mov ds:[0x800410a], eax
      [-]440008ff150c400008c705
         // 080033f2: call ds:[lstrcpyA]
         // 080033f8: mov ds:[0x8004434], 0x18
      [-]440008ff1500400008a3
         // 08003411: call ds:[CreateFontIndirectA]
         // 08003417: mov ds:[0x8004414], eax
      [-]68????????ff7508ff15
         // 08003423: push 0x402
         // 08003428: push ss:[ebp+0x8]
         // 0800342b: call ds:[SendMessageA]
      [-]400008eb03
         // 08003431: jmp 0x8003436
      [-]68????????68????????68????????68????????
         // 0800343d: push 0x1f9
         // 08003442: push 0x226
      ...
      [-]8d45d850ff7508ff15
         // 0800363f: lea eax, ss:[ebp+0xffffffffffffffd8]
         // 08003642: push eax
         // 08003643: push ss:[ebp+0x8]
         // 08003646: call ds:[BeginPaint]
      [-]400008eb03
         // 0800364c: jmp 0x8003651
      [-]8d45d850ff7508ff15
         // 08003651: lea eax, ss:[ebp+0xffffffffffffffd8]
         // 08003654: push eax
         // 08003655: push ss:[ebp+0x8]
         // 08003658: call ds:[EndPaint]
      [-]400008eb03
         // 0800365e: jmp 0x8003663
      [-]e9a3040000
         // 08003663: jmp 0x8003b0b
      [-]83f8057553
      ...
      [-]400008eb03
         // 08003727: jmp 0x800372c
      [-]ff1508400008eb03
         // 0800372c: call ds:[GetLastError]
         // 08003732: jmp 0x8003737
      [-]83f8047305
      ...
      [-]8b35104000088d15
         // 0800388b: mov esi, ds:[GetModuleHandleA]
         // 08003891: lea edx, ds:[0x8004088]
      [-]83c2045256e8
      ...
      [-]6a306a0068????????ff7508ff15
         ...
         // 08003938: push 0x0
         // 0800393a: push 0x111
         // 0800393f: push ss:[ebp+0x8]
         // 08003942: call ds:[SendMessageA]
      ...
      [-]6a2e6a0068????????ff7508ff15
         ...
         // 08003998: push 0x0
         // 0800399a: push 0x111
         // 0800399f: push ss:[ebp+0x8]
         // 080039a2: call ds:[SendMessageA]
      [-]83fb307555
      ...
      [-]6a316a0068????????ff7508ff15
         ...
         // 080039f2: push 0x0
         // 080039f4: push 0x111
         // 080039f9: push ss:[ebp+0x8]
         // 080039fc: call ds:[SendMessageA]
      [-]83fb310f8598000000
      ...
      [-]6a326a0068????????ff7508ff15
         ...
         // 08003a91: push 0x0
         // 08003a93: push 0x111
         // 08003a98: push ss:[ebp+0x8]
         // 08003a9b: call ds:[SendMessageA]
      [-]400008eb68
         // 08003aa1: jmp 0x8003b0b
      [-]0bdb7464
         // 08003aa3: or ebx, ebx
      ...
      [-]ff7514ff7510ff750cff7508ff15
         // 08003af7: push ss:[ebp+0x14]
         // 08003afa: push ss:[ebp+0x10]
         // 08003afd: push ss:[ebp+0xc]
         // 08003b00: push ss:[ebp+0x8]
         // 08003b03: call ds:[DefWindowProcA]
      [-]400008eb02
         // 08003b09: jmp 0x8003b0d
      [-]8be55dc21000
      ...
      [-]6a00ff1510400008eb04
         // 08003b48: push 0x0
         // 08003b4a: call ds:[GetModuleHandleA]
         // 08003b50: jmp 0x8003b56
      [-]68????????6a00ff1570400008a3
         // 08003b74: push 0x7f00
         // 08003b79: push 0x0
         // 08003b7b: call ds:[LoadIconA]
         // 08003b81: mov ds:[0x80043a4], eax
      [-]68????????6a00ff15
         // 08003b8b: push 0x7f00
         // 08003b90: push 0x0
         // 08003b92: call ds:[LoadCursorA]
      [-]400008892d
         // 08003b98: mov ds:[0x80040f6], ebp
      [-]430008ff15
         // 08003ba8: call ds:[RegisterClassExA]
      [-]400008ff1514400008a3
         // 08003bae: call ds:[GetCommandLineA]
         // 08003bb4: mov ds:[0x800440c], eax
      [-]6a00ff35
         // 08003bb9: push 0x0
      ...
      [-]400008a3
         // 08003bf0: mov ds:[0x8004404], eax
      [-]6a01ff35
         // 08003bf5: push 0x1
         // 08003bf7: push ds:[0x8004404]
      [-]400008ff35
         // 08003c03: push ds:[0x8004404]
      [-]ff1544400008eb03
         // 08003c09: call ds:[UpdateWindow]
         // 08003c0f: jmp 0x8003c14
      [-]33ff8d1d
         // 08003c14: xor edi, edi
         // 08003c16: lea ebx, ds:[0x80043bc]
      [-]40000853ff15
         // 08003c25: push ebx
         // 08003c26: call ds:[DispatchMessageA]
      [-]57575753ff1540
         // 08003c2c: push edi
         // 08003c2d: push edi
         // 08003c2e: push edi
         // 08003c2f: push ebx
         // 08003c30: call ds:[GetMessageA]
      [-]000884c075e4
         // 08003c36: test b1 al, b1 al
         // 08003c38: jnz 0x8003c1e
      [-]eeffffc3
         // 08003c4a: retn 
