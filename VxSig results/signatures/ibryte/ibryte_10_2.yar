rule ibryte_10_2 {
  ...
  strings:
    $ = {
         ...
         // 00470bd8: mov eax, ecx
         // 00470bda: and ds:[eax+0x4], 0x0
         // 00470bde: and ds:[eax+0x8], 0x0
         // 00470be2: mov ds:[eax], ??_7exception@std@@6B@
      [-]8bff558bec568d4508508bf1e8
         // 0044ec0d: mov edi, edi
         // 0044ec0f: push ebp
         // 0044ec10: mov ebp, esp
         // 0044ec12: push esi
         // 0044ec13: lea eax, ss:[ebp+0x8]
         // 0044ec16: push eax
         // 0044ec17: mov esi, ecx
         // 0044ec19: call ??0exception@std@@QAE@ABQBD@Z
      [-]ffffc70600
         // 0044ec1e: mov ds:[esi], ??_7bad_cast@std@@6B@
      [-]8bc65e5dc20400
         // 0044ec24: mov eax, esi
         // 0044ec26: pop esi
         // 0044ec27: pop ebp
         // 0044ec28: retn b2 0x4
      [-]8bff51c701
      ...
      [-]890833c0
         // 004852d5: mov ds:[eax], ecx
         // 004852d7: xor eax, eax
      [-]8bff558bec8b45085633f63bc6751d
