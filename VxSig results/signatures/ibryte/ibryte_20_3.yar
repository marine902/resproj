rule ibryte_20_3 {
  ...
  strings:
    $ = {
         ...
         // 004031d2: mov eax, ecx
         // 004031d4: and ds:[eax+0x4], 0x0
         // 004031d8: and ds:[eax+0x8], 0x0
         // 004031dc: mov ds:[eax], ??_7exception@std@@6B@
      ...
      [-]e899ffffffa3
         // 0040dcf2: call __get_sse2_info
         // 0040dcf7: mov ds:[0x42fcfc], eax
      [-]8bff56b8
