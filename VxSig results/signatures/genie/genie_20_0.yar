rule genie_20_0 {
  ...
  strings:
    $ = {
      ...
      [-]83c4e45356
         // 0040fd3b: add esp, 0xffffffffffffffe4
         // 0040fd3e: push ebx
         // 0040fd3f: push esi
      [-]64ff306489208d55ec
         // 0040fd57: push fs:[eax]
         // 0040fd5a: mov fs:[eax], esp
         // 0040fd5d: lea edx, ss:[ebp+0xffffffffffffffec]
      [-]00008b45ec8945f0c645f4
         // 0040fd67: mov eax, ss:[ebp+0xffffffffffffffec]
         // 0040fd6a: mov ss:[ebp+0xfffffffffffffff0], eax
         // 0040fd6d: mov b1 ss:[ebp+0xfffffffffffffff4], b1 0xb
      [-]00008b45e88945f8c645fc
         // 0040fd7b: mov eax, ss:[ebp+0xffffffffffffffe8]
         // 0040fd7e: mov ss:[ebp+0xfffffffffffffff8], eax
         // 0040fd81: mov b1 ss:[ebp+0xfffffffffffffffc], b1 0xb
      [-]8d45f0506a018d55e4a1
         // 0040fd85: lea eax, ss:[ebp+0xfffffffffffffff0]
         // 0040fd88: push eax
         // 0040fd89: push 0x1
         // 0040fd8b: lea edx, ss:[ebp+0xffffffffffffffe4]
         // 0040fd8e: mov eax, ds:[0x475328]
      [-]8b4de4b201a1
         // 0040fd98: mov ecx, ss:[ebp+0xffffffffffffffe4]
         // 0040fd9b: mov b1 dl, b1 0x1
         // 0040fd9d: mov eax, ds:[0x40f800]
      [-]5a595964891068
         // 0040fdae: pop edx
         // 0040fdaf: pop ecx
         // 0040fdb0: pop ecx
         // 0040fdb1: mov fs:[eax], edx
         // 0040fdb4: push 0x40fdce
      [-]64ff306489208d55fca1
      ...
      [-]53568b45088b40fce8
         // 00450cc0: push ebx
         // 00450cc1: push esi
         // 00450cc2: mov eax, ss:[ebp+0x8]
         // 00450cc5: mov eax, ds:[eax+0xfffffffffffffffc]
         // 00450cc8: call 0x45160d
      [-]8b45088b40fc
