  ...
  strings:
    $ = {
      ...
      [-]6a00ff35????????6a015768????????68????????6a466a0a68????????6a0068????????6a00ff15
         ...
         // 004031e3: push 0x0
         // 004031e5: call ds:[CreateWindowExA]
      [-]a3????????ff15
      ...
      [-]6a00ff35????????6a02ff750c6a2268????????68????????6a0a68????????68????????68????????6a00ff15
         ...
         // 0040322a: push 0x0
         // 0040322c: call ds:[CreateWindowExA]
      ...
      [-]a1????????50ff15
         ...
         // 00403313: push eax
         // 00403314: call ds:[PostQuitMessage]
      [-]e9d3050000
      ...
      [-]40a3????????58c1e0080105????????ff35????????ff15
         ...
         // 00403579: call ds:[DestroyWindow]
      [-]e96e030000
      ...
      [-]ff7514ff7510ff750cff7508ff15
         ...
         // 004038ea: call ds:[DefWindowProcA]
      [-]8be55dc21000
      ...
      [-]8bcd558bec83c104890d????????ff15
         ...
         // 00403908: call ds:[GetCommandLineA]
      [-]a3????????6a00ff15
         // 0040390e: mov ds:[0x404658], eax
         // 00403913: push 0x0
         // 00403915: call ds:[GetModuleHandleA]
      ...
      [-]6a00ff35????????6a006a0068????????68????????68????????68????????68????????68????????68????????6a00ff15
         ...
         // 004039d4: push 0x0
         // 004039d6: call ds:[CreateWindowExA]
      [-]a3????????6a05ff35????????ff15
         // 004039dc: mov ds:[0x404650], eax
         // 004039e1: push 0x5
         // 004039e3: push ds:[0x404650]
         // 004039e9: call ds:[ShowWindow]
      [-]ff35????????ff15
         // 004039ef: push ds:[0x404650]
         // 004039f5: call ds:[UpdateWindow]
      [-]33ff8d1d????????eb0e
