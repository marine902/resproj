rule darkkomet_20_1 {
  ...
  strings:
    $ = {
      ...
      [-]8b43088bd08bc6e8
         // 00414276: mov eax, ds:[ebx+0x8]
         // 00414279: mov edx, eax
         // 0041427b: mov eax, esi
         // 0041427d: call 0x41402c
      [-]fdffffe98d020000
         // 00414282: jmp 0x414514
      [-]8bd06681ea00017407
      ...
      [-]8b43088bd08bc6e8
         // 00414992: mov eax, ds:[ebx+0x8]
         // 00414995: mov edx, eax
         // 00414997: mov eax, esi
         // 00414999: call 0x414754
      [-]fdffffe98d020000
         // 0041499e: jmp 0x414c30
      [-]8bd06681ea00017407
