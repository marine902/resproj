  ...
  strings:
    $ = {
      ...
      [-]5a595964891068
         ...
         // 0040c8ac: pop ecx
         // 0040c8ad: pop ecx
         // 0040c8ae: mov fs:[eax], edx
         // 0040c8b1: push 0x40c8cb
      [-]558bec81c4????????5356
         // 0040df54: push ebp
      ...
      [-]f9ffff8b
         // 00414eed: mov edx, ss:[ebp+0xffffffffffffff90]
      [-]ffffeb28
         // 00414ef7: jmp 0x414f21
      [-]faffff84c07514
         // 00414f09: test b1 al, b1 al
         // 00414f0b: jnz 0x414f21
      [-]f9ffff8b
         // 00414f17: mov edx, ss:[ebp+0xffffffffffffff8c]
      [-]5a595964891068
         // 00414516: pop edx
         // 00414517: pop ecx
         // 00414518: pop ecx
      ...
      [-]f9ffff8b
         // 004155ff: mov edx, ss:[ebp+0xffffffffffffff94]
      [-]ffffeb28
         // 00415609: jmp 0x415633
      [-]faffff84c07514
         // 0041561b: test b1 al, b1 al
         // 0041561d: jnz 0x415633
      [-]f9ffff8b
         // 00415629: mov edx, ss:[ebp+0xffffffffffffff90]
      [-]5a595964891068
         // 00415635: pop edx
         // 00415636: pop ecx
         // 00415637: pop ecx
         // 00415638: mov fs:[eax], edx
         // 0041563b: push 0x4156b0
      [-]ffff8d45
         // 0041564d: lea eax, ss:[ebp+0xffffffffffffff98]
      [-]ffff8d45
         // 00415667: lea eax, ss:[ebp+0xffffffffffffffb8]
      [-]ffff8d45
         // 00415681: lea eax, ss:[ebp+0xffffffffffffffd0]
      [-]ffff8d45f0
         // 0041569b: lea eax, ss:[ebp+0xfffffffffffffff0]
      [-]e8d7ffffffc3
      ...
      [-]8b45f48b008b18
         // 0041e2cd: mov eax, ss:[ebp+0xfffffffffffffff4]
         // 0041e2d0: mov eax, ds:[eax]
         // 0041e2d2: mov ebx, ds:[eax]
      [-]83f8100f87
         // 0041e2d7: cmp eax, 0x10
         // 0041e2da: ja def_41E2E0
      [-]8b45fce8
      ...
      [-]558bec83c4f8538955fc8945f88b45f85068
         // 00427dc4: push ebp
         // 00427dc5: mov ebp, esp
         // 00427dc7: add esp, 0xfffffffffffffff8
         // 00427dca: push ebx
         // 00427dcb: mov ss:[ebp+0xfffffffffffffffc], edx
         // 00427dce: mov ss:[ebp+0xfffffffffffffff8], eax
         // 00427dd1: mov eax, ss:[ebp+0xfffffffffffffff8]
         // 00427dd4: push eax
         // 00427dd5: push @Graphics@TPicture@ReadData$qqrp15Classes@TStream
      [-]8b45f85068
         // 00427dda: mov eax, ss:[ebp+0xfffffffffffffff8]
         // 00427ddd: push eax
         // 00427dde: push @Graphics@TPicture@WriteData$qqrp15Classes@TStream
      [-]55e85fffffff59
         // 00427de3: push ebp
         // 00427de4: call 0x427d48
         // 00427de9: pop ecx
      [-]8b45fc8b18ff53085b59595dc3
         // 00427df1: mov eax, ss:[ebp+0xfffffffffffffffc]
         // 00427df4: mov ebx, ds:[eax]
         // 00427df6: call ds:[ebx+0x8]
         // 00427df9: pop ebx
         // 00427dfa: pop ecx
         // 00427dfb: pop ecx
         // 00427dfc: pop ebp
      ...
      [-]8b10ff5204c3
         ...
         // 0042e1b9: retn 
      [-]e83dffffffc3
         // 0043dfc6: call @Controls@TWinControl@AlignControl$qqrp17Controls@TControl
         // 0043dfcb: retn 
      [-]ff84c07417
         // 0045919d: test b1 al, b1 al
         // 0045919f: jz 0x4591b8
      [-]84db7409
         // 004421b5: test b1 bl, b1 bl
         // 004421b7: jz 0x4421c2
      [-]5f5e5bc3
         // 004421cc: pop edi
         // 004421cd: pop esi
         // 004421ce: pop ebx
         // 004421cf: retn 
      [-]895020c3
         // 004438ec: mov ds:[eax+0x20], edx
         // 004438ef: retn 
      [-]8b400ce8
         // 0044399c: mov eax, ds:[eax+0xc]
         // 0044399f: call 0x443338
      [-]f9ffffc3
         // 004439a4: retn 
      [-]8b4008e8
         // 004439c4: mov eax, ds:[eax+0x8]
         // 004439c7: call 0x443338
      [-]f9ffffc3
         // 004439cc: retn 
      [-]ff406cc3
         // 00443ba0: inc ds:[eax+0x6c]
         // 00443ba3: retn 
      [-]5a595964891068
         // 0047303b: pop edx
         // 0047303c: pop ecx
         // 0047303d: pop ecx
         // 0047303e: mov fs:[eax], edx
         // 00473041: push 0x47305b
      [-]5a595964891068
         // 004936e3: pop edx
         // 004936e4: pop ecx
         // 004936e5: pop ecx
         // 004936e6: mov fs:[eax], edx
         // 004936e9: push 0x493703
      [-]558bec83c4f8
         // 00494d10: push ebp
         // 00494d11: mov ebp, esp
         // 00494d13: add esp, 0xffffffffffffffec
         // 00494d21: mov ss:[ebp+0xfffffffffffffff8], ecx
      [-]515151515151
         // 0048bdd9: push ecx
         // 0048bdda: push ecx
         // 0048bddb: push ecx
         ...
         // 0048bdde: push ecx
      [-]8d45e88b
         // 0048be85: lea eax, ss:[ebp+0xffffffffffffffe8]
         // 0048be88: mov edx, ebx
      [-]64ff306489
         // 004960db: push fs:[eax]
         // 004960de: mov fs:[eax], esp
      [-]558bec6a006a006a00535657
         // 00496a40: push ebp
         // 00496a41: mov ebp, esp
         // 00496a43: push 0x0
         // 00496a45: push 0x0
         // 00496a47: push 0x0
         // 00496a49: push ebx
         ...
         // 00496a4b: push edi
      [-]64ff30648920
         // 00496a69: push fs:[eax]
         // 00496a6c: mov fs:[eax], esp
      [-]558bec6a006a00
         // 00496e18: push ebp
         // 00496e19: mov ebp, esp
         // 00496e1b: push 0x0
         // 00496e1d: push 0x0
      [-]5a595964891068
         // 00497011: pop edx
         // 00497012: pop ecx
         // 00497013: pop ecx
         // 00497014: mov fs:[eax], edx
         // 00497017: push 0x497031
