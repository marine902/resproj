rule urelas_40_0 {
  ...
  strings:
    $ = {
      ...
      [-]568bf1e8
         // 004114a4: push esi
         // 004114a5: mov esi, ecx
         // 004114a7: call 0x41148f
      [-]fffffff6
         // 004114ac: test b1 ss:[ebp+0x8], b1 0x1
      [-]08017407
         // 004114b0: jz 0x4114b9
      [-]85c07402
      ...
      [-]558bec83ec
         // 00423ca1: push ebp
         // 00423ca2: mov ebp, esp
         // 00423ca4: sub esp, 0x14
      [-]535657e8
         // 00423ca7: push ebx
         // 00423ca8: push esi
         // 00423ca9: push edi
         // 00423caa: call __encoded_null
      [-]5f5e5bc9c3
         // 0040cfc2: pop edi
         // 0040cfc3: pop esi
         // 0040cfc4: pop ebx
      ...
      [-]8b4dfc5f5e33cd5be8
         // 0033919e: mov ecx, ss:[ebp+0xfffffffffffffffc]
         // 003391a1: pop edi
         // 003391a2: pop esi
         // 003391a3: xor ecx, ebp
         // 003391a5: pop ebx
         // 003391a6: call 0x3288aa
      [-]558bec83ec28a1
         // 002b7a45: push ebp
      ...
      [-]8b4dfc5f5e33cd5be8
         // 0041970d: mov ecx, ss:[ebp+0xfffffffffffffffc]
         // 00419710: pop edi
         // 00419711: pop esi
         // 00419712: xor ecx, ebp
         // 00419714: pop ebx
         // 00419715: call 0x40a982
      [-]558bec83ec
         // 004191a9: push ebp
