rule urelas_30_1 {
  ...
  strings:
    $ = {
      ...
      [-]558bec83ec
         // 011b7c81: push ebp
         // 011b7c82: mov ebp, esp
         // 011b7c84: sub esp, 0x14
      [-]535657e8
         // 011b7c87: push ebx
         // 011b7c88: push esi
         // 011b7c89: push edi
         // 011b7c8a: call __encoded_null
      [-]ffffc70424
         // 011b7cd3: mov ss:[esp], 0x11bf6c0
      [-]ffd650e8
         // 011b7ce0: call esi
         // 011b7ce2: push eax
         // 011b7ce3: call __encode_pointer
      [-]ffffc70424
         // 011b7ce8: mov ss:[esp], 0x11bf6ac
      [-]ffd650e8
         // 011b7cf5: call esi
         // 011b7cf7: push eax
         // 011b7cf8: call __encode_pointer
      [-]57ffd650e8
         // 0040ceef: push edi
         // 0040cef0: call esi
         // 0040cef2: push eax
