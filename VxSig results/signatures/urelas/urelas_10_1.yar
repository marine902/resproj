rule urelas_10_1 {
  ...
  strings:
    $ = {
         83c410c3
         // 00403125: add esp, 0x10
         // 00403128: retn 
      [-]83c410c3
         // 00404c62: add esp, 0x10
         // 00404c65: retn 
      [-]6a01e81fffffff59c3
         // 011aedcb: push 0x1
      ...
      [-]8b4dfc5f5e33cd5be8
         // 0041fd19: mov ecx, ss:[ebp+0xfffffffffffffffc]
         // 0041fd1c: pop edi
         // 0041fd1d: pop esi
         // 0041fd1e: xor ecx, ebp
         // 0041fd20: pop ebx
         // 0041fd21: call 0x4012de
      [-]feffc9c3
         // 0041fd26: leave 
         // 0041fd27: retn 
      ...
      [-]83650800568d75e08d7dd4a5a5a58b35
         // 0042067b: and ss:[ebp+0x8], 0x0
         // 0042067f: push esi
         // 00420680: lea esi, ss:[ebp+0xffffffffffffffe0]
         // 00420683: lea edi, ss:[ebp+0xffffffffffffffd4]
         // 00420686: movsdd 
         // 00420687: movsdd 
         // 00420688: movsdd 
         // 00420689: mov esi, ds:[0x42c710]
      [-]4e8d4e018bc19983e21f03c2c1f8058bd181e2????????895df08945f47905
         // 0042068f: dec esi
         // 00420690: lea ecx, ds:[esi+0x1]
         // 00420693: mov eax, ecx
         // 00420695: cdq 
         // 00420696: and edx, 0x1f
         // 00420699: add eax, edx
         // 0042069b: sar eax, b1 0x5
         // 0042069e: mov edx, ecx
         // 004206a0: and edx, 0xffffffff8000001f
         // 004206a6: mov ss:[ebp+0xfffffffffffffff0], ebx
         // 004206a9: mov ss:[ebp+0xfffffffffffffff4], eax
         // 004206ac: jns 0x4206b3
      [-]4a83cae042
         // 011ba3eb: dec edx
      ...
      [-]4e8d4e018bc19983e21f03c2c1f8058bd181e2????????8945f47905
         // 00420840: dec esi
         // 00420841: lea ecx, ds:[esi+0x1]
         // 00420844: mov eax, ecx
         // 00420846: cdq 
         // 00420847: and edx, 0x1f
         // 0042084a: add eax, edx
         // 0042084c: sar eax, b1 0x5
         // 0042084f: mov edx, ecx
         // 00420851: and edx, 0xffffffff8000001f
         // 00420857: mov ss:[ebp+0xfffffffffffffff4], eax
         // 0042085a: jns 0x420861
      [-]4a83cae042
         // 011ba599: dec edx
