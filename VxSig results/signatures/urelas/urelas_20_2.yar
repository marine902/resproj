rule urelas_20_2 {
  ...
  strings:
    $ = {
      ...
      [-]558bec83ec28a1
         // 0041f8c6: push ebp
         // 0041f8c7: mov ebp, esp
         // 0041f8c9: sub esp, 0x28
         // 0041f8cc: mov eax, ds:[0x42a044]
      [-]33c58945fc53568b750857ff75108b7d0c8d4ddce8
         // 0041f8d1: xor eax, ebp
         // 0041f8d3: mov ss:[ebp+0xfffffffffffffffc], eax
         // 0041f8d6: push ebx
         // 0041f8d7: push esi
         // 0041f8d8: mov esi, ss:[ebp+0x8]
         // 0041f8db: push edi
         // 0041f8dc: push ss:[ebp+0x10]
         // 0041f8df: mov edi, ss:[ebp+0xc]
         // 0041f8e2: lea ecx, ss:[ebp+0xffffffffffffffdc]
         // 0041f8e5: call ??0_LocaleUpdate@@QAE@PAUlocaleinfo_struct@@@Z
      [-]8d45dc5033db53535353578d45d8508d45f050e8
         // 0041f8ea: lea eax, ss:[ebp+0xffffffffffffffdc]
         // 0041f8ed: push eax
         // 0041f8ee: xor ebx, ebx
         // 0041f8f0: push ebx
         // 0041f8f1: push ebx
         // 0041f8f2: push ebx
         // 0041f8f3: push ebx
         // 0041f8f4: push edi
         // 0041f8f5: lea eax, ss:[ebp+0xffffffffffffffd8]
         // 0041f8f8: push eax
         // 0041f8f9: lea eax, ss:[ebp+0xfffffffffffffff0]
         // 0041f8fc: push eax
         // 0041f8fd: call ___strgtold12_l
      [-]00008945ec8d45f05650e8
         // 0041f902: mov ss:[ebp+0xffffffffffffffec], eax
         // 0041f905: lea eax, ss:[ebp+0xfffffffffffffff0]
         // 0041f908: push esi
         // 0041f909: push eax
         // 0041f90a: call 0x420277
      [-]000083c428f645ec03752b
         // 0041f90f: add esp, 0x28
         // 0041f912: test b1 ss:[ebp+0xffffffffffffffec], b1 0x3
         // 0041f916: jnz 0x41f943
      [-]83f8017511
