rule uztuby_30_0 {
  ...
  strings:
    $ = {
      ...
      [-]0085c075
         // 0040a72e: test eax, eax
         // 0040a730: jnz 0x40a742
      [-]0000008b
         // 0040f94a: mov ecx, esi
      [-]0085c074
         // 0040cebc: test eax, eax
         // 0040cebe: jz 0x40cec6
      [-]8a41fc3001
      ...
      [-]0f83e00f8b
         // 0040efc0: and eax, 0xf
         // 0040efc3: mov edx, ds:[edx+ecx*0x4]
      [-]0783e10f83c00283
      ...
      [-]000085c07403
         // 0041c3e8: test eax, eax
         // 0041c3ea: jz 0x41c3ef
      [-]00008bd0
