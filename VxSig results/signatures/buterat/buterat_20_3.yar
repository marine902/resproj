  ...
  strings:
    $ = {
      ...
      [-]895c2420895c2424895c241c53eb5b
         // 004026fb: mov ss:[esp+0x20], ebx
         // 004026ff: mov ss:[esp+0x24], ebx
         // 00402703: mov ss:[esp+0x1c], ebx
         // 00402707: push ebx
         // 00402708: jmp 0x402765
      [-]837c2414057367
         // 004026ff: cmp ss:[esp+0x14], 0x5
         // 00402704: jnb 0x40276d
      [-]81ec????????6a21598db424????????8bfcf3a5e8bc0000008bf081c4????????3bf3750a
         // 00402706: sub esp, 0x84
         // 0040270c: push 0x21
         // 0040270e: pop ecx
         // 0040270f: lea esi, ss:[esp+0xa4]
         // 00402716: mov edi, esp
         // 00402718: rep movsdd 
         // 0040271a: call 0x4027db
         // 0040271f: mov esi, eax
         // 00402721: add esp, 0x84
         // 00402727: cmp esi, ebx
         // 00402729: jnz 0x402735
      [-]ff442418895c2414eb04
         // 0040272b: inc ss:[esp+0x18]
         // 0040272f: mov ss:[esp+0x14], ebx
         // 00402733: jmp 0x402739
      [-]ff442414
         // 00402735: inc ss:[esp+0x14]
      ...
      [-]8d44242c50ff742420ff550c83c41485c07592
         // 0040275a: lea eax, ss:[esp+0x2c]
         // 0040275e: push eax
         // 0040275f: push ss:[esp+0x20]
         // 00402763: call ss:[ebp+0xc]
         // 00402766: add esp, 0x14
         // 00402769: test eax, eax
         // 0040276b: jnz 0x4026ff
      [-]33c93bc37407
         // 0040277d: xor ecx, ecx
         // 0040277f: cmp eax, ebx
         // 00402781: jz 0x40278a
      [-]389c248e000000742d
         // 0040277f: cmp b1 ss:[esp+0x8e], b1 bl
         // 00402786: jz 0x4027b5
      ...
      [-]5f5e33c05b8be55dc3
         // 004027d2: pop edi
         // 004027d3: pop esi
         // 004027d4: xor eax, eax
         // 004027d6: pop ebx
         // 004027d7: mov esp, ebp
         // 004027d9: pop ebp
         // 004027da: retn 
      ...
      [-]58e91a040000
         // 00402802: pop eax
         // 00402803: jmp 0x402c22
      [-]8b7d6883ff017405
         // 00402808: mov edi, ss:[ebp+0x68]
         // 0040280b: cmp edi, 0x1
         // 0040280e: jz 0x402815
      [-]83ff057518
         // 00402810: cmp edi, 0x5
         // 00402813: jnz 0x40282d
      [-]8d85????????50ba
         // 00402820: lea eax, ss:[ebp+0xfffffffffffff724]
         // 00402826: push eax
         // 00402827: mov edx, 0x40e318
      [-]0000598db5????????
         // 00402831: pop ecx
         // 00402832: lea esi, ss:[ebp+0xfffffffffffff724]
      ...
      [-]33c040e9cd030000
         // 0040284c: xor eax, eax
         // 0040284e: inc eax
         // 0040284f: jmp 0x402c21
      [-]83ff027405
         // 00402854: cmp edi, 0x2
         // 00402857: jz 0x40285e
      [-]83ff077510
         // 00402859: cmp edi, 0x7
         // 0040285c: jnz 0x40286e
      [-]8b4d6d518acde8
      ...
      [-]83ff070f85d7000000
         // 0040287f: cmp edi, 0x7
         // 00402882: jnz 0x40295f
      [-]33c03905
      ...
      [-]ffb4b524ffffffff15
         // 00402927: push ss:[ebp+esi*0x4]
         // 0040292e: call ds:[SysFreeString]
      [-]4000463b75f47ced
         // 00402934: inc esi
         // 00402935: cmp esi, ss:[ebp+0xfffffffffffffff4]
         // 00402938: jl 0x402927
      [-]83bd????????017404
         // 0040292f: cmp ss:[ebp+0x80], 0x1
         // 00402936: jz 0x40293c
      [-]33c0eb08
         // 00402938: xor eax, eax
         // 0040293a: jmp 0x402944
      [-]8a4575e8
      ...
      [-]33db399d????????0f84a2020000
         // 00402965: xor ebx, ebx
         // 00402967: cmp ss:[ebp+0x88], ebx
         // 0040296d: jz 0x402c15
      [-]33f6837d680175
         // 00402973: xor esi, esi
         // 00402975: cmp ss:[ebp+0x68], 0x1
         // 00402979: jnz 0x4029b1
