rule buterat_30_2 {
  ...
  strings:
    $ = {
      ...
      [-]00008b1d
         // 00402a7e: mov ebx, ds:[0x42050c]
      [-]8d0c9d??
         // 00402a84: lea ecx, ds:[0x41a718+ebx*0x4]
      [-]39017312
         // 00402a8b: cmp ds:[ecx], eax
         // 00402a8d: jnb 0x402aa1
      [-]0fb6015032c9e8
      ...
      [-]8b5d148bd0c1e2028b82
         // 00402cde: mov ebx, ss:[ebp+0x14]
         // 00402ce1: mov edx, eax
         // 00402ce3: shl edx, b1 0x2
         // 00402ce6: mov eax, ds:[edx+0x41aca0]
      [-]3bd88955080f8d1f010000
         // 00402cec: cmp ebx, eax
         // 00402cee: mov ss:[ebp+0x8], edx
         // 00402cf1: jge 0x402e16
      ...
      [-]00008b3d
         // 00402d46: mov edi, ds:[0x420520]
      [-]39017312
         // 00402d53: cmp ds:[ecx], eax
         // 00402d55: jnb 0x402d69
      [-]0fb6015032c9e8
      ...
      [-]ff368b15
         // 00402d9c: push ds:[esi]
         // 00402d9e: mov edx, ds:[0x41cb68]
      [-]0000ff7604ff36e8
         // 00402da9: push ds:[esi+0x4]
         // 00402dac: push ds:[esi]
         // 00402dae: call 0x405169
      [-]000083c40c3b3d
         // 00402db3: add esp, 0xc
         // 00402db6: cmp edi, ds:[0x41c4a0]
      [-]8d4418013904bd
      ...
      [-]8b5d143bd80f8d7f010000
         // 0040306f: mov ebx, ss:[ebp+0x14]
         // 00403072: cmp ebx, eax
         // 00403074: jge 0x4031f9
      ...
      [-]00008846658b0d
         // 0040330f: mov b1 ds:[esi+0x65], b1 al
         // 00403312: mov ecx, ds:[0x41ae8c]
      [-]00008846698b4514403905
         // 0040331d: mov b1 ds:[esi+0x69], b1 al
         // 00403320: mov eax, ss:[ebp+0x14]
         // 00403323: inc eax
         // 00403324: cmp ds:[0x42052c], eax
      [-]33c040eb04
      ...
      [-]c6466b0fc6466c058b0d
         // 00403d0b: mov b1 ds:[esi+0x6b], b1 0xf
         // 00403d0f: mov b1 ds:[esi+0x6c], b1 0x5
         // 00403d13: mov ecx, ds:[0x41ae88]
      [-]0000884665eb0c
         // 00403d1e: mov b1 ds:[esi+0x65], b1 al
         // 00403d21: jmp 0x403d2f
