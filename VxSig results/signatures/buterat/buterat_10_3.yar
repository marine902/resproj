rule buterat_10_3 {
  ...
  strings:
    $ = {
      ...
      [-]8b3cbd??
         // 004011aa: mov edi, ds:[0x41fb68+edi*0x4]
      [-]8b5608e8
      ...
      [-]8d0cbd??
         // 0040139c: lea ecx, ds:[0x41f5e0+edi*0x4]
      [-]39017312
      ...
      [-]8bd8c1e3028b83
         ...
         // 004014f3: mov eax, ds:[ebx+0x413248]
      [-]3945140f8d43010000
      ...
      [-]8d4302890495
         ...
         // 0040170e: mov ds:[0x414d28+edx*0x4], eax
      [-]c1e7028b87
         // 0040171c: shl edi, b1 0x2
         // 0040171f: mov eax, ds:[edi+0x4131f8]
      [-]3bc17409
      ...
      [-]8b4514403b87
         ...
         // 004017ca: inc eax
         // 004017cb: cmp eax, ds:[edi+0x414d28]
      ...
      [-]885e75885e748b04bd
         ...
         // 004019a7: mov eax, ds:[0x414dc8+edi*0x4]
      [-]894670899e????????
      ...
      [-]ff368b15
         ...
         // 00401a32: mov edx, ds:[0x424414]
      [-]3a0000ff34bd
         // 00401a3d: push ds:[0x414dc8+edi*0x4]
      [-]3a0000a1
         // 00401a4b: mov eax, ds:[0x4287d4]
      [-]83c40cc1e002473bb8
         // 00401a50: add esp, 0xc
         // 00401a53: shl eax, b1 0x2
         // 00401a56: inc edi
         // 00401a57: cmp edi, ds:[eax+0x4177f8]
      [-]ff76088b90
      ...
      [-]ff368b97
         ...
         // 00401b80: mov edx, ds:[edi+0x4233d8]
      [-]390000ff76048b97
         // 00401b8b: push ds:[esi+0x4]
         // 00401b8e: mov edx, ds:[edi+0x423568]
      [-]390000a1
         // 00401b99: mov eax, ds:[0x4287e0]
      [-]433b1c85
         // 00401b9e: inc ebx
         // 00401b9f: cmp ebx, ds:[0x414b48+eax*0x4]
      [-]59597531
         // 00401ba6: pop ecx
         // 00401ba7: pop ecx
      ...
      [-]8d049d??
         // 004022db: lea eax, ds:[0x420020+ebx*0x4]
      [-]8b083bca7c04
      ...
      [-]33c93bc37407
         // 00402772: xor ecx, ecx
         // 00402774: cmp eax, ebx
         // 00402776: jz 0x40277f
      [-]389c248e000000742d
