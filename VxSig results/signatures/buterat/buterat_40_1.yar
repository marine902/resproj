rule buterat_40_1 {
  ...
  strings:
    $ = {
         558bec83ec10f605
         // 004029c0: push ebp
         // 004029c1: mov ebp, esp
         // 004029c3: sub esp, 0x10
         // 004029c6: test b1 ds:[0x420570], b1 0x1
      [-]4200017513
         // 004029cd: jnz 0x4029e2
      ...
      [-]33db891d
         // 004029fc: xor ebx, ebx
         // 004029fe: mov ds:[0x42050c], ebx
      [-]394d18752f
      ...
      [-]0fb6015032c9e8
         // 00402a8f: movzx eax, b1 ds:[ecx]
         // 00402a92: push eax
         // 00402a93: xor b1 cl, b1 cl
         // 00402a95: call 0x407298
      [-]00008b1d
         // 00402a9a: mov ebx, ds:[0x42050c]
      [-]0043891d
         // 00402aa8: inc ebx
         // 00402aa9: mov ds:[0x42050c], ebx
      [-]837d1004750a
         // 00401101: cmp ss:[ebp+0x10], 0x4
         // 00401105: jnz 0x401111
      [-]8d470289049d
         // 00402ab7: lea eax, ds:[edi+0x2]
         // 00402aba: mov ds:[0x4203c8+ebx*0x4], eax
      [-]483bd87d6b
         // 00402acf: dec eax
         // 00402ad0: cmp ebx, eax
         // 00402ad2: jge 0x402b3f
      [-]8bc3c1e0028d88
      ...
      [-]668b0066a3
         // 00402b51: mov b2 ax, b2 ds:[eax]
         // 00402b54: mov b2 ds:[0x420420], b2 ax
      [-]8b5608e8
      ...
      [-]8b45148d48018b45183b88
         // 00402be2: mov eax, ss:[ebp+0x14]
         // 00402be5: lea ecx, ds:[eax+0x1]
         // 00402be8: mov eax, ss:[ebp+0x18]
         // 00402beb: cmp ecx, ds:[eax+0x4203c8]
      ...
      [-]668b0066a3
         // 00402d27: mov b2 ax, b2 ds:[eax]
         // 00402d2a: mov b2 ds:[0x420428], b2 ax
      [-]83f901753e
      ...
      [-]0fb6015032c9e8
         // 00402d57: movzx eax, b1 ds:[ecx]
         // 00402d5a: push eax
         // 00402d5b: xor b1 cl, b1 cl
         // 00402d5d: call 0x407298
      [-]00008b3d
         // 00402d62: mov edi, ds:[0x420520]
      [-]8b550847893d
         // 00402d69: mov edx, ss:[ebp+0x8]
         // 00402d6c: inc edi
         // 00402d6d: mov ds:[0x420520], edi
      [-]ff76048b92
      ...
      [-]00008b0d
         // 0040309f: mov ecx, ds:[0x420528]
      [-]3901730c
         // 004030ac: cmp ds:[ecx], eax
         // 004030ae: jnb 0x4030bc
      [-]0fb6015032c9e8
         // 004030b0: movzx eax, b1 ds:[ecx]
         // 004030b3: push eax
         // 004030b4: xor b1 cl, b1 cl
         // 004030b6: call 0x407298
      [-]837d10047510
      ...
      [-]668b0066a3
         // 004030ee: mov b2 ax, b2 ds:[eax]
         // 004030f1: mov b2 ds:[0x420424], b2 ax
      [-]ff368b15
         // 00401747: push ds:[esi]
         // 00401749: mov edx, ds:[0x4163e4]
      [-]0000ff349d
         // 00401754: push ds:[0x418b00+ebx*0x4]
      [-]0000ff35
         // 00401762: push ds:[0x41b080]
      [-]0000ff35
         // 0040176f: push ds:[0x4187d8]
      [-]00008b1c9d
         // 0040177c: mov ebx, ds:[0x418328+ebx*0x4]
      [-]83c41c85db7445
         // 00401783: add esp, 0x1c
         // 00401786: test ebx, ebx
         // 00401788: jz 0x4017cf
      [-]000085c0ff76047423
      ...
      [-]8b4514403905
         // 004034a2: mov eax, ss:[ebp+0x14]
         // 004034a5: inc eax
         // 004034a6: cmp ds:[0x420538], eax
      [-]33c040eb03
      ...
      [-]00008dbd
         // 00402029: lea edi, ss:[ebp+0xffffffffffffde64]
      [-]00008b7d
         // 0040203a: mov edi, ss:[ebp+0x1c]
      [-]85ff740d
         // 0040203d: test edi, edi
         // 0040203f: jz 0x40204e
      [-]0000eb08
      ...
      [-]8d43013b0495
         // 00403a93: lea eax, ds:[ebx+0x1]
         // 00403a96: cmp eax, ds:[0x4154d8+edx*0x4]
      [-]00008b3c9d
      ...
      [-]0000996a6459f7f933c0bf????????85d20f9cc0
         ...
         // 004022f2: pop ecx
         // 004022f3: idiv ecx
         // 004022f5: xor eax, eax
         // 004022f7: mov edi, 0x10000
         // 004022fc: test edx, edx
         // 004022fe: setl b1 al
      [-]c700????????
      ...
      [-]8b45188b0d
         // 00403b3e: mov eax, ss:[ebp+0x18]
         // 00403b41: mov ecx, ds:[0x420554]
      [-]99f7f93bd789542410752b
         // 00403b47: cdq 
         // 00403b48: idiv ecx
         // 00403b4a: cmp edx, edi
         // 00403b4c: mov ss:[esp+0x10], edx
         // 00403b50: jnz 0x403b7d
      [-]397d187426
      ...
      [-]68????????ff
         ...
         // 00402566: call ebx
      [-]000083f80175ef
         // 004041c6: cmp eax, 0x1
         // 004041c9: jnz 0x4041ba
      [-]000083c4
      ...
      [-]ffb424????????8a8c2490000000ff442420e8
         // 00404758: push ss:[esp+0x8b]
         // 0040475f: mov b1 cl, b1 ss:[esp+0x90]
         // 00404766: inc ss:[esp+0x20]
         // 0040476a: call 0x407298
      [-]000059ff74241cff74241c56
         // 0040476f: pop ecx
         // 00404770: push ss:[esp+0x1c]
         // 00404774: push ss:[esp+0x1c]
         // 00404778: push esi
      ...
      [-]0fb6842495000000500fb6842498000000500fb6842496000000518b8c24????????6a0150e8
         // 004047a7: movzx eax, b1 ss:[esp+0x95]
         // 004047af: push eax
         // 004047b0: movzx eax, b1 ss:[esp+0x98]
         // 004047b8: push eax
         // 004047b9: movzx eax, b1 ss:[esp+0x96]
         // 004047c1: push ecx
         // 004047c2: mov ecx, ss:[esp+0x9c]
         // 004047c9: push 0x1
         // 004047cb: push eax
         // 004047cc: call 0x4098c8
      [-]000083c414
         // 004047d1: add esp, 0x14
      [-]ff75108a4d14e8
      ...
      [-]5653ff751433c9ff750cff7508e8
         // 0040484c: push esi
         // 0040484d: push ebx
         // 0040484e: push ss:[ebp+0x14]
         // 00404851: xor ecx, ecx
         // 00404853: push ss:[ebp+0xc]
         // 00404856: push ss:[ebp+0x8]
         // 00404859: call 0x409303
      [-]000083c41485c0750e
         // 0040485e: add esp, 0x14
         // 00404861: test eax, eax
         // 00404863: jnz 0x404873
      [-]33c040e9
      ...
      [-]8b4d6d518acde8
         // 0040488d: mov ecx, ss:[ebp+0x6d]
         // 00404890: push ecx
         // 00404891: mov b1 cl, b1 ch
         // 00404893: call 0x407298
      [-]000083ff02597409
         // 00404898: cmp edi, 0x2
         // 0040489b: pop ecx
         // 0040489c: jz 0x4048a7
      [-]83ff070f85d7000000
         // 0040288a: cmp edi, 0x7
         // 0040288d: jnz 0x40296a
      [-]33c03905
         // 004048a7: xor eax, eax
         // 004048a9: cmp ds:[0x420430], eax
      [-]505033f68ac3e8
         // 004048bd: push eax
         // 004048be: push eax
         // 004048bf: xor esi, esi
         // 004048c1: mov b1 al, b1 bl
         // 004048c3: call 0x408200
      [-]000083c414
         // 004048c8: add esp, 0x14
      [-]000f84a6000000
         // 004048d2: jz 0x40497e
      [-]80ff6ab8
         // 004048d8: cmp b1 bh, b1 0x6a
         // 004048db: mov eax, 0x4089dc
      [-]6a2157508d85
         // 004028c8: push 0x21
         // 004028ca: push edi
         // 004028cb: push eax
      ...
      [-]8a4575e8
         // 0040495b: mov b1 al, b1 ss:[ebp+0x75]
         // 0040495e: call 0x408482
      [-]5333c0e800
         // 00402956: push ebx
      ...
      [-]837d6803bb
         // 00404a4f: cmp ss:[ebp+0x68], 0x3
         // 00404a53: mov ebx, 0x408b18
      [-]6a0b508a45758d75
         // 00402a49: push 0xb
         // 00402a4b: push eax
      ...
      [-]ff757533c0e8
         // 00404ae5: push ss:[ebp+0x75]
         // 00404ae8: xor eax, eax
         // 00404aea: call 0x40961f
      [-]000085f6597507
         // 00404aef: test esi, esi
         // 00404af1: pop ecx
         // 00404af2: jnz 0x404afb
      [-]33db837d6801c745
      ...
      [-]ff757533c0e8
         // 00404bd2: push ss:[ebp+0x75]
         // 00404bd5: xor eax, eax
         // 00404bd7: call 0x40961f
      [-]00008bc3
         // 00404bdc: mov eax, ebx
      [-]5f5e5bc9c3
         // 00402c2d: pop edi
         // 00402c2e: pop esi
         // 00402c2f: pop ebx
