rule buterat_10_0 {
  ...
  strings:
    $ = {
         ...
         // 00401016: test b1 ds:[0x42a528], b1 0x1
      [-]4200017513
      ...
      [-]8d0c9d??
         // 004010d4: lea ecx, ds:[0x41f400+ebx*0x4]
      [-]39017312
      ...
      [-]0fb6015032c9e8
         ...
         // 004010e5: call 0x4079f9
      [-]00008b1d
         // 004010ea: mov ebx, ds:[0x42a4c0]
      [-]0043891d
         // 004010f8: inc ebx
         // 004010f9: mov ds:[0x42a4c0], ebx
      [-]837d1004750a
         // 00401101: cmp ss:[ebp+0x10], 0x4
         // 00401105: jnz 0x401111
      [-]8d470289049d
         // 00401107: lea eax, ds:[edi+0x2]
         // 0040110a: mov ds:[0x426378+ebx*0x4], eax
      [-]483bd87d6b
         // 0040111f: dec eax
      ...
      [-]8b45148d48018b45183b88
         ...
         // 0040123b: cmp ecx, ds:[eax+0x426378]
      [-]c646650fc6466605c6466b00c6466c058bb8
         ...
         // 00401253: mov edi, ds:[eax+0x420e00]
      [-]8bd743e8
         // 00401260: mov edx, edi
         // 00401262: inc ebx
         // 00401263: call 0x405464
      [-]000085c0ff76087505
      ...
      [-]c6467500c64674008b0c85
         ...
         // 004012c9: mov ecx, ds:[0x425db0+eax*0x4]
      [-]894e7089be????????
      ...
      [-]668b0066a3
         ...
         // 0040137a: mov b2 ds:[0x4263dc], b2 ax
      [-]83f901753e
      ...
      [-]0fb6015032c9e8
         ...
         // 004013ad: call 0x4079f9
      [-]00008b3d
         // 004013b2: mov edi, ds:[0x42a4d4]
      [-]8b550847893d
         // 004013b9: mov edx, ss:[ebp+0x8]
         // 004013bc: inc edi
         // 004013bd: mov ds:[0x42a4d4], edi
      [-]ff76048b92
      ...
      [-]03c38b0c85
         ...
         // 004013dd: mov ecx, ds:[0x4253c0+eax*0x4]
      [-]8b4604e8
         // 004013e4: mov eax, ds:[esi+0x4]
         // 004013e7: call 0x40578b
      [-]ff368b15
         // 004013ec: push ds:[esi]
         // 004013ee: mov edx, ds:[0x420dfc]
      [-]0000ff7604ff36e8
         // 004013f9: push ds:[esi+0x4]
         // 004013fc: push ds:[esi]
         // 004013fe: call 0x405526
      [-]000083c40c3b3d
         // 00401403: add esp, 0xc
         // 00401406: cmp edi, ds:[0x4203ec]
      [-]8d4418013904bd
      ...
      [-]c6466701c6466804c646693cc6466a41c646650fc64666058a0d
         ...
         // 004014c2: mov b1 cl, b1 ds:[0x42297c]
      [-]4200884e6b8a0d
         // 004014c8: mov b1 ds:[esi+0x6b], b1 cl
         // 004014cb: mov b1 cl, b1 ds:[0x422980]
      [-]4200884e6c8b0d
         // 004014d1: mov b1 ds:[esi+0x6c], b1 cl
         // 004014d4: mov ecx, ds:[0x41b5b0]
      ...
      [-]00008b0d
         // 004016ef: mov ecx, ds:[0x42a4dc]
      [-]3901730c
         // 004016fc: cmp ds:[ecx], eax
         // 004016fe: jnb 0x40170c
      [-]0fb6015032c9e8
         // 00401700: movzx eax, b1 ds:[ecx]
         // 00401703: push eax
         // 00401704: xor b1 cl, b1 cl
         // 00401706: call 0x4079f9
      [-]837d10047510
      ...
      [-]c1e7028b87
         // 00401731: shl edi, b1 0x2
         // 00401734: mov eax, ds:[edi+0x414208]
      [-]3bc17409
         // 0040173a: cmp eax, ecx
         // 0040173c: jz 0x401747
      [-]668b0066a3
         // 0040173e: mov b2 ax, b2 ds:[eax]
         // 00401741: mov b2 ds:[0x4263d8], b2 ax
      [-]ff368b15
      ...
      [-]8bfbc1e7028b87
         // 004018a7: mov edi, ebx
         // 004018a9: shl edi, b1 0x2
         // 004018ac: mov eax, ds:[edi+0x425230]
      [-]3945140f8dd5000000
         // 004018b2: cmp ss:[ebp+0x14], eax
         // 004018b5: jge 0x401990
      ...
      [-]c6466701c6466807885e6b885e6cc646691ec6466a3cc6466e38c74660????????89460c
         // 004019f3: mov b1 ds:[esi+0x67], b1 0x1
         // 004019f7: mov b1 ds:[esi+0x68], b1 0x7
         // 004019fb: mov b1 ds:[esi+0x6b], b1 bl
         // 004019fe: mov b1 ds:[esi+0x6c], b1 bl
         // 00401a01: mov b1 ds:[esi+0x69], b1 0x1e
         // 00401a05: mov b1 ds:[esi+0x6a], b1 0x3c
         // 00401a09: mov b1 ds:[esi+0x6e], b1 0x38
         // 00401a0d: mov ds:[esi+0x60], 0x9
         // 00401a14: mov ds:[esi+0xc], eax
      ...
      [-]3bc87d75
         // 00401a35: cmp ecx, eax
         // 00401a37: jge 0x401aae
      [-]6bc0033945187d6d
      ...
      [-]ff76088b90
         ...
         // 00401a62: mov edx, ds:[eax+0x420c68]
      [-]0000ff05
         // 00401a6d: inc ds:[0x4287d4]
      ...
      [-]8846758846748b0c9d
         // 00401adc: mov b1 ds:[esi+0x75], b1 al
         // 00401adf: mov b1 ds:[esi+0x74], b1 al
         // 00401ae2: mov ecx, ds:[0x424f08+ebx*0x4]
      [-]894e708986????????
         // 00401ae9: mov ds:[esi+0x70], ecx
         // 00401aec: mov ds:[esi+0x80], eax
      [-]3bd87561
      ...
      [-]8bfbc1e7028b87
         // 00401b6e: mov edi, ebx
         // 00401b70: shl edi, b1 0x2
         // 00401b73: mov eax, ds:[edi+0x425898]
      [-]3bc80f8dc8000000
         // 00401b79: cmp ecx, eax
         // 00401b7b: jge 0x401c49
      ...
      [-]8b4514403905
         // 00401c2a: mov eax, ss:[ebp+0x14]
         // 00401c2d: inc eax
         // 00401c2e: cmp ds:[0x42a4f0], eax
      [-]33c040eb03
      ...
      [-]00008b450c5633c95733ff4133f6897df840eb1c
      ...
      [-]8d85????????e8
         ...
         // 00401cb8: call 0x4054ea
      [-]00008b75f883fe01597532
      ...
      [-]00008bc83bcf750c
         // 00401d2a: mov ecx, eax
         // 00401d2c: cmp ecx, edi
         // 00401d2e: jnz 0x401d3c
      [-]66c745a8300066897daaeb08
      ...
      [-]8d95????????e8
         ...
         // 00401da9: call 0x407197
      [-]00008d85????????5053e8
         // 00401db9: lea eax, ss:[ebp+0xffffffffffffee64]
         // 00401dbf: push eax
         // 00401dc0: push ebx
         // 00401dc1: call 0x405526
      [-]000083c410eb0d
      ...
      [-]8d85????????5053e8
         ...
         // 00401dde: push eax
         // 00401ddf: push ebx
         // 00401de0: call 0x405526
      [-]00008d45805053e8
         // 00401de5: lea eax, ss:[ebp+0xffffffffffffff80]
         // 00401de8: push eax
         // 00401de9: push ebx
         // 00401dea: call 0x405526
      [-]00008d85????????
      ...
      [-]00008bc83bcf7512
         // 00401e2c: mov ecx, eax
         // 00401e2e: cmp ecx, edi
         // 00401e30: jnz 0x401e44
      [-]66c78554ffffff30006689bd56ffffffeb0b
      ...
      [-]8d95????????e8
         ...
         // 00401f0d: call 0x407197
      [-]00008d85????????5053e8
         // 00401f1d: lea eax, ss:[ebp+0xffffffffffffce64]
         // 00401f23: push eax
         // 00401f24: push ebx
         // 00401f25: call 0x405526
      [-]000083c410eb0d
      ...
      [-]8b45288b3cb08d95????????e8
         ...
         // 00401f6f: call 0x407197
      [-]00008d85????????5053e8
         // 00401f74: lea eax, ss:[ebp+0xfffffffffffffe64]
         // 00401f7a: push eax
         // 00401f7b: push ebx
         // 00401f7c: call 0x405526
      [-]00004683fe0b59597cda
         // 00401f81: inc esi
      ...
      [-]8d85????????5053e8
         ...
         // 00401fd0: push eax
         // 00401fd1: push ebx
         // 00401fd2: call 0x405526
      [-]00008d45d05053e8
         // 00401fd7: lea eax, ss:[ebp+0xffffffffffffffd0]
         // 00401fda: push eax
         // 00401fdb: push ebx
         // 00401fdc: call 0x405526
      [-]000083c410
      ...
      [-]00008dbd????????8d95????????e8
         ...
         // 00402007: call 0x407247
      [-]00008b7d1c85ff740d
         // 0040200c: mov edi, ss:[ebp+0x1c]
         // 0040200f: test edi, edi
         // 00402011: jz 0x402020
      [-]8d95????????e8
         // 00402041: lea edx, ss:[ebp+0xffffffffffffee64]
         // 00402047: call 0x4076ac
      [-]0000eb08
         // 0040204c: jmp 0x402056
      [-]6683a564eeffff00
      ...
      [-]8d85????????e8
         ...
         // 004020b9: call 0x4054ea
      [-]00008b8cb52cffffffe8
         // 004020be: mov ecx, ss:[ebp+esi*0x4]
         // 004020c5: call 0x4054ea
      [-]000046ebdc
         // 004020ca: inc esi
      ...
      [-]00006683a564eeffff008d450c508d85????????6a5e506633ffb8
      ...
      [-]8d85????????e8
         ...
         // 00402115: call 0x4054ea
      [-]00008b8cb52cffffffe8
         // 0040211a: mov ecx, ss:[ebp+esi*0x4]
         // 00402121: call 0x4054ea
      [-]000046ebdc
         // 00402126: inc esi
      ...
      [-]8d95????????e8
         ...
         // 004021b3: call 0x407197
      [-]00008d85????????5053e8
         // 004021c3: lea eax, ss:[ebp+0xffffffffffffee64]
         // 004021c9: push eax
         // 004021ca: push ebx
         // 004021cb: call 0x405526
      [-]000083c410eb17
      ...
      [-]8d85????????5053e8
         ...
         // 004021f2: push eax
         // 004021f3: push ebx
         // 004021f4: call 0x405526
      [-]00008d85????????5053e8
         // 004021f9: lea eax, ss:[ebp+0xffffffffffffff54]
         // 004021ff: push eax
         // 00402200: push ebx
         // 00402201: call 0x405526
      [-]00008d4580e9
      ...
      [-]8d43013b0495
         // 004022b8: lea eax, ds:[ebx+0x1]
         // 004022bb: cmp eax, ds:[0x41b100+edx*0x4]
      [-]00008b3c9d
      ...
      [-]0000996a6459f7f933c0bf????????85d20f9cc033d242a3
         // 004022c1: cdq 
         // 004022c2: push 0x64
         // 004022c4: pop ecx
         // 004022c5: idiv ecx
      ...
      [-]8b45188b0d
         // 00402362: mov eax, ss:[ebp+0x18]
         // 00402365: mov ecx, ds:[0x42a50c]
      [-]99f7f93bd789542410752b
         // 0040236b: cdq 
         // 0040236c: idiv ecx
         // 0040236e: cmp edx, edi
         // 00402370: mov ss:[esp+0x10], edx
         // 00402374: jnz 0x4023a1
      [-]397d187426
         // 00402348: cmp ss:[ebp+0x18], edi
         // 0040234b: jz 0x402373
      [-]8b86????????fe467483f8017512
         // 00402381: mov eax, ds:[esi+0x80]
         // 00402387: inc b1 ds:[esi+0x74]
         // 0040238a: cmp eax, 0x1
         // 0040238d: jnz 0x4023a1
      [-]fe46753bc0750b
      ...
      [-]8bfbc1e7028b87
         // 004023a1: mov edi, ebx
         // 004023a3: shl edi, b1 0x2
         // 004023a6: mov eax, ds:[edi+0x425230]
      [-]0fafc13945187c07
         // 004023ac: imul eax, ecx
         // 004023af: cmp ss:[ebp+0x18], eax
         // 004023b2: jl 0x4023bb
      [-]33c0e9a8010000
      ...
      [-]4a3bc27513
         // 004023f7: dec edx
         // 004023f8: cmp eax, edx
         // 004023fa: jnz 0x40240f
      [-]49394c2410750c
         // 004023ce: dec ecx
      ...
      [-]6bdb3c81c3
         ...
         // 00402440: add ebx, 0x4133d8
      [-]8b1effb7
         // 0040244d: mov ebx, ds:[esi]
         // 0040244f: push ds:[edi+0x423fc0]
      [-]ff742428ff742424ffb7
         // 00402455: push ss:[esp+0x28]
         // 00402459: push ss:[esp+0x24]
         // 0040245d: push ds:[edi+0x417668]
      [-]ff74242cffb7
         // 00402469: push ss:[esp+0x2c]
         // 0040246d: push ds:[edi+0x420020]
      [-]f7ffff8b1d
         // 00402478: mov ebx, ds:[0x4287e4]
      [-]83c42485c0a3
         // 0040247e: add esp, 0x24
         // 00402481: test eax, eax
         // 00402483: mov ds:[0x4246cc], eax
      [-]8b442420403bd8750c
      ...
      [-]ff76048946788b97
         ...
         // 004024b2: mov edx, ds:[edi+0x417668]
      ...
      [-]40005633f63935
         ...
         // 00402553: cmp ds:[0x4114d4], esi
      [-]68????????ffd3
         // 00402561: push 0x2710
         // 00402566: call ebx
      [-]000083f80175ef
         // 004029ef: cmp eax, 0x1
         // 004029f2: jnz 0x4029e3
      [-]6a04566a07e8
         // 004029f9: push 0x4
         // 004029fb: push esi
         // 004029fc: push 0x7
         // 004029fe: call 0x40ac2d
      [-]000083c40c
         // 00402a03: add esp, 0xc
      [-]400033ff3975
      ...
      [-]6a04566a08e8
         ...
         // 00402a47: push esi
         // 00402a48: push 0x8
         // 00402a4a: call 0x40ac2d
      [-]000083c40c
         // 00402a4f: add esp, 0xc
      [-]6a448d45
         // 004025d3: push 0x44
      ...
      [-]558bec83e4f8b8????????e8
         // 00402af9: push ebp
         // 00402afa: mov ebp, esp
         // 00402afc: and esp, 0xfffffffffffffff8
         // 00402aff: mov eax, 0x309c
         // 00402b04: call __alloca_probe
      [-]af00008a4518888424810000000fb6c08d8c24????????6bc014894c24148d8c24????????894c24185333db395d088d8c24????????894c24208b4d1c565766899c24a800000066899c24a810000066899c24a82000008988
         // 00402b09: mov b1 al, b1 ss:[ebp+0x18]
         // 00402b0c: mov b1 ss:[esp+0x81], b1 al
         // 00402b13: movzx eax, b1 al
         // 00402b16: lea ecx, ss:[esp+0x209c]
         // 00402b1d: imul eax, b1 0x14
         // 00402b20: mov ss:[esp+0x14], ecx
         // 00402b24: lea ecx, ss:[esp+0x109c]
         // 00402b2b: mov ss:[esp+0x18], ecx
         // 00402b2f: push ebx
         // 00402b30: xor ebx, ebx
         // 00402b32: cmp ss:[ebp+0x8], ebx
         // 00402b35: lea ecx, ss:[esp+0xa0]
         // 00402b3c: mov ss:[esp+0x20], ecx
         // 00402b40: mov ecx, ss:[ebp+0x1c]
         // 00402b43: push esi
         // 00402b44: push edi
         // 00402b45: mov b2 ss:[esp+0xa8], b2 bx
         // 00402b4d: mov b2 ss:[esp+0x10a8], b2 bx
         // 00402b55: mov b2 ss:[esp+0x20a8], b2 bx
         // 00402b5d: mov ds:[eax+0x42a400], ecx
      [-]895c24100f8e
         // 00402b63: mov ss:[esp+0x10], ebx
         // 00402b67: jle 0x402c5c
      [-]5353895c2420895c2424895c241c53eb5b
         // 004026ee: push ebx
         // 004026ef: push ebx
      ...
      [-]ffb424????????8a8c2490000000ff442420e8
         // 00402bc3: push ss:[esp+0x8b]
         // 00402bca: mov b1 cl, b1 ss:[esp+0x90]
         // 00402bd1: inc ss:[esp+0x20]
         // 00402bd5: call 0x4079f9
      [-]000059ff74241cff74241c56
         // 00402bda: pop ecx
         // 00402bdb: push ss:[esp+0x1c]
         // 00402bdf: push ss:[esp+0x1c]
         // 00402be3: push esi
      ...
      [-]0fb6842495000000500fb6842498000000500fb6842496000000518b8c24????????6a0150e8
         // 00402c12: movzx eax, b1 ss:[esp+0x95]
         // 00402c1a: push eax
         // 00402c1b: movzx eax, b1 ss:[esp+0x98]
         // 00402c23: push eax
         // 00402c24: movzx eax, b1 ss:[esp+0x96]
         // 00402c2c: push ecx
         // 00402c2d: mov ecx, ss:[esp+0x9c]
         // 00402c34: push 0x1
         // 00402c36: push eax
         // 00402c37: call 0x40ada0
      [-]000083c414
         // 00402c3c: add esp, 0x14
      [-]ff75108a4d14e8
         // 00402c3f: push ss:[ebp+0x10]
         // 00402c42: mov b1 cl, b1 ss:[ebp+0x14]
         // 00402c45: call 0x4079f9
      [-]0000ff4424148b4424143b4508590f8c
         // 00402c4a: inc ss:[esp+0x14]
         // 00402c4e: mov eax, ss:[esp+0x14]
         // 00402c52: cmp eax, ss:[ebp+0x8]
         // 00402c55: pop ecx
         // 00402c56: jl 0x402b6d
      [-]5f5e33c05b8be55dc3
         // 004027dd: pop edi
         // 004027de: pop esi
         ...
         // 004027e4: pop ebp
         // 004027e5: retn 
      [-]558bec81ec????????53565733f656ff15
         // 004027e6: push ebp
         // 004027e7: mov ebp, esp
         // 004027e9: sub esp, 0x8e0
         // 004027ef: push ebx
         // 004027f0: push esi
         // 004027f1: push edi
         // 004027f2: xor esi, esi
         // 004027f4: push esi
         // 004027f5: call ds:[OleInitialize]
      [-]40008b5d755333c0e8
         // 004027fb: mov ebx, ss:[ebp+0x75]
         // 004027fe: push ebx
         // 004027ff: xor eax, eax
         // 00402801: call 0x40a469
      [-]000085c0597508
         // 00402806: test eax, eax
         // 00402808: pop ecx
         // 00402809: jnz 0x402813
      [-]58e91a040000
         // 0040280d: pop eax
         // 0040280e: jmp 0x402c2d
      [-]8b7d6883ff017405
      ...
      [-]8d85????????50ba
         // 00402815: lea eax, ss:[ebp+0xfffffffffffff724]
         // 0040281b: push eax
         // 0040281c: mov edx, 0x40e320
      [-]0000598db5????????
         // 00402826: pop ecx
      ...
      [-]5653ff751433c9ff750cff7508e8
         // 00402cb7: push esi
         // 00402cb8: push ebx
         // 00402cb9: push ss:[ebp+0x14]
         // 00402cbc: xor ecx, ecx
         // 00402cbe: push ss:[ebp+0xc]
         // 00402cc1: push ss:[ebp+0x8]
         // 00402cc4: call 0x40a7ec
      [-]000083c41485c0750e
         // 00402cc9: add esp, 0x14
         // 00402ccc: test eax, eax
         // 00402cce: jnz 0x402cde
      [-]33c040e9cd030000
      ...
      [-]8b4d6d518acde8
         // 00402cf8: mov ecx, ss:[ebp+0x6d]
         // 00402cfb: push ecx
         // 00402cfc: mov b1 cl, b1 ch
         // 00402cfe: call 0x40a3d2
      [-]000083ff02597409
         // 00402d03: cmp edi, 0x2
         // 00402d06: pop ecx
         // 00402d07: jz 0x402d12
      [-]83ff070f85d7000000
         // 0040288a: cmp edi, 0x7
         // 0040288d: jnz 0x40296a
      [-]33c03905
         // 00402d12: xor eax, eax
         // 00402d14: cmp ds:[0x4263e4], eax
      [-]505033f68ac3e8
         // 00402d28: push eax
         // 00402d29: push eax
         // 00402d2a: xor esi, esi
         // 00402d2c: mov b1 al, b1 bl
         // 00402d2e: call 0x4093cd
      [-]000083c414
         // 00402d33: add esp, 0x14
      [-]000f84a6000000
         // 00402d3d: jz 0x402de9
      [-]80ff6ab8
         // 00402d43: cmp b1 bh, b1 0x6a
         // 00402d46: mov eax, 0x409c34
      [-]6a2157508d85????????6a21508d75f48ac3e8
         // 00402d52: push 0x21
         // 00402d54: push edi
         // 00402d55: push eax
         // 00402d56: lea eax, ss:[ebp+0xffffffffffffff24]
         // 00402d5c: push 0x21
         // 00402d5e: push eax
         // 00402d5f: lea esi, ss:[ebp+0xfffffffffffffff4]
         // 00402d62: mov b1 al, b1 bl
         // 00402d64: call 0x4093cd
      [-]000083c41485c07465
         // 00402d69: add esp, 0x14
         // 00402d6c: test eax, eax
         // 00402d6e: jz 0x402dd5
      [-]8b45f48b1d
         // 004028f1: mov eax, ss:[ebp+0xfffffffffffffff4]
         // 004028f4: mov ebx, ds:[0x41f554]
      [-]00008b3d
         // 00402904: mov edi, ds:[SysAllocString]
      [-]40008bf0ffb4b524ffffffffd78935
      ...
      [-]33f63975f4a3
         ...
         // 00402920: mov ds:[0x4114d8], eax
      [-]ffb4b524ffffffff15
         // 0040291c: push ss:[ebp+esi*0x4]
         // 00402923: call ds:[SysFreeString]
      [-]4000463b75f47ced
         // 00402929: inc esi
         // 0040292a: cmp esi, ss:[ebp+0xfffffffffffffff4]
         // 0040292d: jl 0x40291c
      [-]83bd????????017404
         // 0040293a: cmp ss:[ebp+0x80], 0x1
         // 00402941: jz 0x402947
      [-]33c0eb08
         // 00402943: xor eax, eax
         // 00402945: jmp 0x40294f
      [-]8a4575e8
         // 00402dc6: mov b1 al, b1 ss:[ebp+0x75]
         // 00402dc9: call 0x409664
      [-]5333c0e8
         // 00402956: push ebx
         // 00402957: xor eax, eax
         // 00402959: call 0x40a65e
      [-]00008325
         // 0040295e: and ds:[0x4114d8], 0x0
      [-]00e9edfeffff
         // 00402965: jmp 0x402857
      [-]33db399d????????0f84a2020000
         // 00402970: xor ebx, ebx
         // 00402972: cmp ss:[ebp+0x88], ebx
         // 00402978: jz 0x402c20
