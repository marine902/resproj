rule buterat_40_0 {
  ...
  strings:
    $ = {
      ...
      [-]ff368b97
         // 004018cf: push ds:[esi]
         // 004018d1: mov edx, ds:[edi+0x4187e0]
      [-]00008b97
         // 004018dc: mov edx, ds:[edi+0x424bb8]
      [-]59ff7604e8
         // 004018e2: pop ecx
         // 004018e3: push ds:[esi+0x4]
         // 004018e6: call 0x4057af
      [-]433b1c85
         // 004018f0: inc ebx
         // 004018f1: cmp ebx, ds:[0x41b100+eax*0x4]
      [-]00008b8f
      ...
      [-]00008d45
         // 00401da4: lea eax, ss:[ebp+0xffffffffffffffa8]
      [-]00008b7d
         // 00401dae: mov edi, ss:[ebp+0x1c]
      [-]83c41085ff7428
         // 00401db1: add esp, 0x10
         // 00401db4: test edi, edi
         // 00401db6: jz 0x401de0
      [-]00008d85
      ...
      [-]33c040e9
         // 00401e14: xor eax, eax
         // 00401e16: inc eax
         // 00401e17: jmp 0x40223e
      [-]00008bc83bcf75
      ...
      [-]00008d85
         // 00401f32: lea eax, ss:[ebp+0xffffffffffffce64]
      [-]000083c410eb0d
         // 00401f3f: add esp, 0x10
         // 00401f42: jmp 0x401f51
      [-]00005959
         // 00401f3a: pop ecx
         // 00401f3b: pop ecx
      [-]00005959e9
      ...
      [-]00008dbd
         // 004038ad: lea edi, ss:[ebp+0xffffffffffffde98]
      [-]00008b7d
         // 004038be: mov edi, ss:[ebp+0x20]
      [-]85ff740d
         // 004038c1: test edi, edi
         // 004038c3: jz 0x4038d2
      [-]0000eb08
      ...
      [-]8a4575e8
         // 00402e05: mov b1 al, b1 ss:[ebp+0x75]
         // 00402e08: call 0x40aa10
      [-]00006a2168
         // 00402e0d: push 0x21
         // 00402e0f: push 0x4098a9
      [-]6a218d8d
         // 00402e14: push 0x21
         // 00402e16: lea ecx, ss:[ebp+0xffffffffffffff24]
      [-]51508d5d
         // 00402e1c: push ecx
         // 00402e1d: push eax
         // 00402e1e: lea ebx, ss:[ebp+0xfffffffffffffff8]
      [-]000083c4148d55
         // 00402e29: add esp, 0x14
         // 00402e2c: lea edx, ss:[ebp+0xfffffffffffffff4]
      [-]8bf08b45
         // 00402e2f: mov esi, eax
         // 00402e31: mov eax, ss:[ebp+0xfffffffffffffff0]
      [-]8b085250ff5178
         // 00402e34: mov ecx, ds:[eax]
         // 00402e36: push edx
         // 00402e37: push eax
         // 00402e38: call ds:[ecx+0x78]
      [-]837d68057536
      ...
      [-]00008985
         // 00402a0c: mov ss:[ebp+0xffffffffffffff24], eax
      [-]0000ff7510ffd7ff35
         // 00402a1c: push ss:[ebp+0x10]
         // 00402a1f: call edi
         // 00402a21: push ds:[0x4114c8]
      [-]837d6803bb
         // 00402eba: cmp ss:[ebp+0x68], 0x3
         // 00402ebe: mov ebx, 0x409db0
      [-]6a0b508a45758d75
         // 00402a49: push 0xb
         // 00402a4b: push eax
      ...
      [-]ff757533c0e8
         // 00402f83: push ss:[ebp+0x75]
         // 00402f86: xor eax, eax
         // 00402f88: call 0x40ab05
      [-]000085f6597507
         // 00402f8d: test esi, esi
         // 00402f8f: pop ecx
         // 00402f90: jnz 0x402f99
      [-]33db837d6801c745
         // 00402b20: xor ebx, ebx
         // 00402b22: cmp ss:[ebp+0x68], 0x1
         // 00402b26: mov ss:[ebp+0xfffffffffffffff0], 0x1
      [-]6a035999f7f98bdebf
         // 00402b27: push 0x3
         // 00402b29: pop ecx
         // 00402b2a: cdq 
      ...
      [-]000099f77d
         // 00402b6b: cdq 
         // 00402b6c: idiv ss:[ebp+0xfffffffffffffff8]
      [-]837d6806750b
      ...
      [-]ff757533c0e8
         // 0040309f: push ss:[ebp+0x75]
         // 004030a2: xor eax, eax
         // 004030a4: call 0x40ab05
      [-]00008bc3
         // 004030a9: mov eax, ebx
      [-]5f5e5bc9c3
         // 00402c2d: pop edi
         // 00402c2e: pop esi
         // 00402c2f: pop ebx
      ...
      [-]6a7cc1e602508b86
         // 00404e3a: push 0x7c
         // 00404e3c: shl esi, b1 0x2
         // 00404e3f: push eax
         // 00404e40: mov eax, ds:[esi+0x41fdd8]
      [-]6633ffe8
         // 00404e46: xor b2 di, b2 di
         // 00404e50: call 0x405460
      [-]508bd7e8
         // 00402edd: push eax
         // 00402ede: mov edx, edi
         // 00402ee0: call 0x40550e
      [-]000059b9
         // 00402ee5: pop ecx
         // 00402ee6: mov ecx, 0x40e33c
      [-]00008b8e
         // 00402ef6: mov ecx, ds:[esi+0x423ef8]
      [-]00008b96
         // 00402f01: mov edx, ds:[esi+0x4150a8]
      [-]000085c07506
         // 00402f15: test eax, eax
         // 00402f17: jnz 0x402f1f
      [-]6a03ffb6
         // 00404f57: push 0x3
         // 00404f59: push ds:[esi+0x410600]
      [-]ffff83c4
         // 00404f6e: add esp, 0x1c
      [-]6a00ff15
         // 00404fac: push 0x0
         // 00404fae: call ds:[ExitProcess]
      [-]558bec51535657e8
         // 004032b8: push ebp
      ...
      [-]57ffd668
         // 00403351: push edi
         // 00403352: call esi
         // 00403354: push 0x40e3b8
      [-]ffd6391d??
         // 0040336c: call esi
         // 0040336e: cmp ds:[0x4131f0], ebx
      [-]33c0891d
      ...
      [-]feffff83c40c85c00f84d4000000
         // 00405a32: add esp, 0xc
         // 00405a35: test eax, eax
         // 00405a37: jz 0x405b11
      [-]feffff83c40c85c00f84b9000000
         // 00405a4d: add esp, 0xc
         // 00405a50: test eax, eax
         // 00405a52: jz 0x405b11
      [-]ffff83c40c85
         // 00405a68: add esp, 0xc
         // 00405a6b: test eax, eax
         // 00405a6d: jz 0x405b11
